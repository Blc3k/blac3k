...
{{text = 'Delete Instagram',url="https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/"},{text = 'Delete sookBchat',url="https://accounts.sookBchat.com/accounts/login?continue=https%3A%2F%2Faccounts.sookBchat.com%2Faccounts%2Fdeleteaccount"}},{{text= '❲ 𝘴????𝘱 𝖲𝗈𝗎𝗋𝖼𝖾 ❳',url="t.me/ooo_od"}}
}
local msg_id = msg.id/2097152/0.5
...
if text == (Redis:get(ThesookB.."sookB:Name:Bot") or "آيلاند") then
local photo = LuaTele.getUserProfilePhotos(ThesookB)
local UserInfo = LuaTele.getUser(ThesookB)
for Name_User in string.gmatch(UserInfo.first_name, "[^%s]+" ) do
UserInfo.first_name = Name_User
...
local NamesBot = (Redis:get(ThesookB.."sookB:Name:Bot") or "آيلاند")
local BotName = {
"يروح "..NamesBot.. " كول؟",
"انا "..NamesBot.. " القميل",
"هاعمري",
