...
local Theblac3k = io.open("Theblac3k", 'w')
Theblac3k:write([[
cd $(cd $(dirname $0); pwd)
while(true) do
sudo lua5.3 blac3kbot.lua
done
]])
Theblac3k:close()
...
cd $(cd $(dirname $0); pwd)
while(true) do
screen -S Theblac3k -X kill
screen -S Theblac3k ./Theblac3k
done
]])
Run:close()
...
os.execute('chmod +x Theblac3k;chmod +x Run;./Run')
end
...
Theblac3k = Token:match("(%d+)")
os.execute('sudo rm -fr .CallBack-Bot/'..Theblac3k)
LuaTele = luatele.set_config{api_id=2692371,api_hash='fe85fff033dfe0f328aeb02b4f784930',session_name=Theblac3k,token=Token}
function var(value)  
...
Status = 0
DevelopersQ = Redis:sismember(Theblac3k.."blac3k:DevelopersQ:Groups",UserId) 
...
Status = 0
Developers = Redis:sismember(Theblac3k.."blac3k:Developers:Groups",UserId) 
DevelopersQ = Redis:sismember(Theblac3k.."blac3k:DevelopersQ:Groups",UserId) 
TheBasicsQ = Redis:sismember(Theblac3k.."blac3k:TheBasicsQ:Group"..ChatId,UserId) 
TheBasics = Redis:sismember(Theblac3k.."blac3k:TheBasics:Group"..ChatId,UserId) 
Originators = Redis:sismember(Theblac3k.."blac3k:Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(Theblac3k.."blac3k:Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(Theblac3k.."blac3k:Addictive:Group"..ChatId,UserId)
Distinguished = Redis:sismember(Theblac3k.."blac3k:Distinguished:Group"..ChatId,UserId)
...
Status = Redis:get(Theblac3k.."blac3k:Developer:Bot:Reply"..ChatId) or 'المطور'
elseif TheBasicsQ then
Status = "المالك"
elseif TheBasics then
Status = Redis:get(Theblac3k.."blac3k:President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Originators then
Status = Redis:get(Theblac3k.."blac3k:Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Managers then
Status = Redis:get(Theblac3k.."blac3k:Manager:Group:Reply"..ChatId) or 'المدير'
elseif Addictive then
Status = Redis:get(Theblac3k.."blac3k:Admin:Group:Reply"..ChatId) or 'الادمن'
elseif StatusMember == "chatMemberStatusCreator" then
Status = 'مالك الكروب'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = 'ادمن المجموعه'
elseif Distinguished then
Status = Redis:get(Theblac3k.."blac3k:Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(Theblac3k.."blac3k:Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(Theblac3k.."blac3k:lockpin"..ChatId) then    
lock_pin = "✔️"
else 
lock_pin = "❌"    
end
if Redis:get(Theblac3k.."blac3k:Lock:tagservr"..ChatId) then    
lock_tagservr = "✔️"
else 
lock_tagservr = "❌"
end
if Redis:get(Theblac3k.."blac3k:Lock:text"..ChatId) then    
lock_text = "✔️"
else 
lock_text = "❌ "    
end
if Redis:get(Theblac3k.."blac3k:Lock:AddMempar"..ChatId) == "kick" then
lock_add = "✔️"
else 
lock_add = "❌ "    
end    
if Redis:get(Theblac3k.."blac3k:Lock:Join"..ChatId) == "kick" then
lock_join = "✔️"
else 
lock_join = "❌ "    
end    
if Redis:get(Theblac3k.."blac3k:Lock:edit"..ChatId) then    
lock_edit = "✔️"
else 
lock_edit = "❌ "    
end
if Redis:get(Theblac3k.."blac3k:Chek:Welcome"..ChatId) then
welcome = "✔️"
else 
welcome = "❌ "    
end
if Redis:hget(Theblac3k.."blac3k:Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(Theblac3k.."blac3k:Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقيد "     
elseif Redis:hget(Theblac3k.."blac3k:Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(Theblac3k.."blac3k:Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "✔️"
else     
flood = "❌ "     
end
if Redis:get(Theblac3k.."blac3k:Lock:Photo"..ChatId) == "del" then
lock_photo = "✔️" 
elseif Redis:get(Theblac3k.."blac3k:Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقيد "   
elseif Redis:get(Theblac3k.."blac3k:Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(Theblac3k.."blac3k:Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "❌ "   
end    
if Redis:get(Theblac3k.."blac3k:Lock:Contact"..ChatId) == "del" then
lock_phon = "✔️" 
elseif Redis:get(Theblac3k.."blac3k:Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقيد "    
elseif Redis:get(Theblac3k.."blac3k:Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(Theblac3k.."blac3k:Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "❌ "    
end    
if Redis:get(Theblac3k.."blac3k:Lock:Link"..ChatId) == "del" then
lock_links = "✔️"
elseif Redis:get(Theblac3k.."blac3k:Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقيد "    
elseif Redis:get(Theblac3k.."blac3k:Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(Theblac3k.."blac3k:Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "❌ "    
end
if Redis:get(Theblac3k.."blac3k:Lock:Cmd"..ChatId) == "del" then
lock_cmds = "✔️"
elseif Redis:get(Theblac3k.."blac3k:Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقيد "    
elseif Redis:get(Theblac3k.."blac3k:Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(Theblac3k.."blac3k:Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "❌ "    
end
if Redis:get(Theblac3k.."blac3k:Lock:User:Name"..ChatId) == "del" then
lock_user = "✔️"
elseif Redis:get(Theblac3k.."blac3k:Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقيد "    
elseif Redis:get(Theblac3k.."blac3k:Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(Theblac3k.."blac3k:Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "❌ "    
end
if Redis:get(Theblac3k.."blac3k:Lock:hashtak"..ChatId) == "del" then
lock_hash = "✔️"
elseif Redis:get(Theblac3k.."blac3k:Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقيد "    
elseif Redis:get(Theblac3k.."blac3k:Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(Theblac3k.."blac3k:Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "❌ "    
end
if Redis:get(Theblac3k.."blac3k:Lock:vico"..ChatId) == "del" then
lock_muse = "✔️"
elseif Redis:get(Theblac3k.."blac3k:Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(Theblac3k.."blac3k:Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(Theblac3k.."blac3k:Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "❌ "    
end 
if Redis:get(Theblac3k.."blac3k:Lock:Video"..ChatId) == "del" then
lock_ved = "✔️"
elseif Redis:get(Theblac3k.."blac3k:Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقيد "    
elseif Redis:get(Theblac3k.."blac3k:Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(Theblac3k.."blac3k:Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "❌ "    
end
if Redis:get(Theblac3k.."blac3k:Lock:Animation"..ChatId) == "del" then
lock_gif = "✔️"
elseif Redis:get(Theblac3k.."blac3k:Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقيد "    
elseif Redis:get(Theblac3k.."blac3k:Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(Theblac3k.."blac3k:Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "❌ "    
end
if Redis:get(Theblac3k.."blac3k:Lock:Sticker"..ChatId) == "del" then
lock_ste = "✔️"
elseif Redis:get(Theblac3k.."blac3k:Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقيد "    
elseif Redis:get(Theblac3k.."blac3k:Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(Theblac3k.."blac3k:Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "❌ "    
end
if Redis:get(Theblac3k.."blac3k:Lock:geam"..ChatId) == "del" then
lock_geam = "✔️"
elseif Redis:get(Theblac3k.."blac3k:Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقيد "    
elseif Redis:get(Theblac3k.."blac3k:Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(Theblac3k.."blac3k:Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "❌ "    
end    
...
if Redis:get(Theblac3k.."blac3k:Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "✔️"
elseif Redis:get(Theblac3k.."blac3k:Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقيد "
elseif Redis:get(Theblac3k.."blac3k:Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(Theblac3k.."blac3k:Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "❌ "
end
if Redis:get(Theblac3k.."blac3k:Lock:forward"..ChatId) == "del" then
lock_fwd = "✔️"
elseif Redis:get(Theblac3k.."blac3k:Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقيد "    
elseif Redis:get(Theblac3k.."blac3k:Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(Theblac3k.."blac3k:Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "❌ "    
end    
if Redis:get(Theblac3k.."blac3k:Lock:Document"..ChatId) == "del" then
lock_file = "✔️"
elseif Redis:get(Theblac3k.."blac3k:Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقيد "    
elseif Redis:get(Theblac3k.."blac3k:Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(Theblac3k.."blac3k:Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "❌ "    
end    
if Redis:get(Theblac3k.."blac3k:Lock:Unsupported"..ChatId) == "del" then
lock_self = "✔️"
elseif Redis:get(Theblac3k.."blac3k:Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقيد "    
elseif Redis:get(Theblac3k.."blac3k:Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(Theblac3k.."blac3k:Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "❌ "    
end
if Redis:get(Theblac3k.."blac3k:Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "✔️"
elseif Redis:get(Theblac3k.."blac3k:Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقيد "   
elseif Redis:get(Theblac3k.."blac3k:Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "❌ "    
end
if Redis:get(Theblac3k.."blac3k:Lock:Markdaun"..ChatId) == "del" then
lock_mark = "✔️"
elseif Redis:get(Theblac3k.."blac3k:Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقيد "    
elseif Redis:get(Theblac3k.."blac3k:Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(Theblac3k.."blac3k:Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "❌ "    
end
if Redis:get(Theblac3k.."blac3k:Lock:Spam"..ChatId) == "del" then    
lock_spam = "✔️"
elseif Redis:get(Theblac3k.."blac3k:Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقيد "    
elseif Redis:get(Theblac3k.."blac3k:Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(Theblac3k.."blac3k:Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "❌ "    
end        
...
return{
BanAll = Redis:sismember(Theblac3k.."blac3k:BanAll:Groups",UserId) ,
BanGroup = Redis:sismember(Theblac3k.."blac3k:BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(Theblac3k.."blac3k:SilentGroup:Group"..ChatId,UserId)
}
end
...
return {
Lock     = '[🔖 ! 𝗦𝙤𝙪𝙧𝘤𝙚 Rocks :](https://t.me/ooo_od)\n*— — — — — — — — —\n‹ : بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n‹ : خاصيه المسح *',
unLock   = '[🔖 ! 𝗦𝙤𝙪𝙧𝘤𝙚 Rocks :](https://t.me/ooo_od)\n*— — — — — — — — —\n‹ : بواسطه ← *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[🔖 ! 𝗦𝙤𝙪𝙧𝘤𝙚 Rocks :](https://t.me/ooo_od)\n*— — — — — — — — —\n‹ : بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n‹ : خاصيه الكتم *',
lockKid  = '[🔖 ! 𝗦𝙤𝙪𝙧𝘤𝙚 Rocks :](https://t.me/ooo_od)\n*— — — — — — — — —\n‹ : بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n‹ : خاصيه التقييد *',
lockKick = '[🔖 ! 𝗦𝙤𝙪𝙧𝘤𝙚 Rocks :](https://t.me/ooo_od)\n*— — — — — — — — —\n‹ : بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n‹ : خاصيه الطرد *',
Reply    = '[🔖 ! 𝗦𝙤𝙪𝙧𝘤𝙚 Rocks :](https://t.me/ooo_od)\n*— — — — — — — — —\n🔰 : المستخدم⇷ *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
local GetMemberStatus = LuaTele.getChatMember(msg.chat_id,Theblac3k).status
if GetMemberStatus.can_change_info then
...
JoinChannel = true
local Channel = Redis:get(Theblac3k..'blac3k:Channel:Join')
if Channel then
...
Redis:incr(Theblac3k..'blac3k:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
...
if tonumber(msg.sender.user_id) == tonumber(Theblac3k) then
...
elseif Redis:sismember(Theblac3k.."blac3k:DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(Theblac3k.."blac3k:Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(Theblac3k.."blac3k:Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(Theblac3k.."blac3k:TheBasicsQ:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = "المالك"
elseif Redis:sismember(Theblac3k.."blac3k:TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(Theblac3k.."blac3k:President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(Theblac3k.."blac3k:Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(Theblac3k.."blac3k:Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(Theblac3k.."blac3k:Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(Theblac3k.."blac3k:Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(Theblac3k.."blac3k:Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(Theblac3k.."blac3k:Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(Theblac3k.."blac3k:Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(Theblac3k.."blac3k:Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(Theblac3k) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(Theblac3k.."blac3k:Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(Theblac3k.."blac3k:Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(Theblac3k.."blac3k:Status:Welcome"..msg_chat_id) then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(Theblac3k.."blac3k:Welcome:Group"..msg_chat_id)
if Welcome then 
if UserInfo.username then
...
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(Theblac3k.."blac3k:Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(Theblac3k) then
return false
end
local floods = Redis:hget(Theblac3k.."blac3k:Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Max = Redis:hget(Theblac3k.."blac3k:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(Theblac3k.."blac3k:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(Theblac3k.."blac3k:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(Theblac3k.."blac3k:Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(Theblac3k.."blac3k:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
...
Redis:setex(Theblac3k.."blac3k:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if Redis:hget(Theblac3k.."blac3k:Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Max = Redis:hget(Theblac3k.."blac3k:Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
if text and Redis:get(Theblac3k..'lock:Fshar'..msg.chat_id) and not msg.Special then 
...
if text and Redis:get(Theblac3k..'lock:Fars'..msg.chat_id) and not msg.Special then 
...
sens = 400  
if Redis:get(Theblac3k.."blac3k:Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(Theblac3k.."blac3k:Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(Theblac3k.."blac3k:Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(Theblac3k.."blac3k:Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(Theblac3k.."blac3k:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Distinguished then -- التوجيه
local Fwd_Group = Redis:get(Theblac3k.."blac3k:Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(Theblac3k.."blac3k:Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(Theblac3k.."blac3k:Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(Theblac3k.."blac3k:Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(Theblac3k.."blac3k:lockpin"..msg_chat_id)
...
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(Theblac3k.."blac3k:Lock:Join"..msg.chat_id) == "kick" then
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end
...
Redis:incr(Theblac3k.."Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(Theblac3k.."Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(Theblac3k.."Lock:Bot:kick"..msg_chat_id)
for k,v in pairs(msg.content.member_user_ids) do
local Info_User = LuaTele.getUser(v) 
print(v)
if v == tonumber(Theblac3k) then
local N = (Redis:get(Theblac3k.."Name:Bot") or "الروكس")
photo = LuaTele.getUserProfilePhotos(Theblac3k)
...
Redis:set(Theblac3k.."Who:Added:Me"..msg_chat_id..":"..v,msg.sender.user_id)
...
Redis:incr(Theblac3k.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
local Contact_Group = Redis:get(Theblac3k.."blac3k:Lock:Contact"..msg_chat_id)
...
local Videonote_Group = Redis:get(Theblac3k.."blac3k:Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(Theblac3k.."blac3k:Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(Theblac3k.."blac3k:Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(Theblac3k.."blac3k:Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(Theblac3k.."blac3k:Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(Theblac3k.."blac3k:Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(Theblac3k.."blac3k:Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(Theblac3k.."blac3k:Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(Theblac3k.."blac3k:Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(Theblac3k.."blac3k:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
local ChatPhoto = LuaTele.setChatPhoto(msg_chat_id,msg.content.photo.sizes[2].photo.remote.id)
if (ChatPhoto.luatele == "error") then
Redis:del(Theblac3k.."blac3k:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(Theblac3k.."blac3k:Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(Theblac3k.."blac3k:Lock:User:Name"..msg_chat_id)
...
if text and text:match("#[%a%d_]+") and not msg.Distinguished then 
local Hashtak_Group = Redis:get(Theblac3k.."blac3k:Lock:hashtak"..msg_chat_id)
...
if text and text:match("/[%a%d_]+") and not msg.Distinguished then 
local comd_Group = Redis:get(Theblac3k.."blac3k:Lock:Cmd"..msg_chat_id)
...
if (Redis:get(Theblac3k..'blac3k:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(Theblac3k.."blac3k:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(Theblac3k.."blac3k:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(Theblac3k.."blac3k:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(Theblac3k.."blac3k:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(Theblac3k.."blac3k:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(Theblac3k.."blac3k:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(Theblac3k.."blac3k:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(Theblac3k.."blac3k:List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(Theblac3k..'blac3k:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : ارسل تحذير ( "..Filters.." ) عند ارساله","md",true)  
end
end
if text and (Redis:get(Theblac3k..'blac3k:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(Theblac3k.."blac3k:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(Theblac3k.."blac3k:Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(Theblac3k.."blac3k:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(Theblac3k..'blac3k:FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : تم اضافه رد التحذير","md",true)  
end
if text and (Redis:get(Theblac3k..'blac3k:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(Theblac3k.."blac3k:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(Theblac3k.."blac3k:Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(Theblac3k.."blac3k:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(Theblac3k.."blac3k:Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(Theblac3k.."blac3k:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(Theblac3k.."blac3k:Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(Theblac3k.."blac3k:List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(Theblac3k.."blac3k:Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(Theblac3k..'blac3k:FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(Theblac3k.."blac3k:Filter:Group:"..DelFilters..msg_chat_id)
...
if text and Redis:get(Theblac3k.."blac3k:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(Theblac3k.."blac3k:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(Theblac3k.."blac3k:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(Theblac3k.."blac3k:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(Theblac3k.."blac3k:Command:List:Group"..msg_chat_id,text)
...
Redis:del(Theblac3k.."blac3k:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(Theblac3k.."blac3k:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(Theblac3k.."blac3k:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(Theblac3k.."blac3k:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(Theblac3k.."blac3k:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(Theblac3k.."blac3k:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(Theblac3k.."blac3k:Command:Reids:Group:New"..msg_chat_id)
Redis:set(Theblac3k.."blac3k:Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(Theblac3k.."blac3k:Command:List:Group"..msg_chat_id,text)
Redis:del(Theblac3k.."blac3k:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم حفظ الامر باسم ← { "..text..' }',"md",true)
end
if Redis:get(Theblac3k.."blac3k:Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(Theblac3k.."blac3k:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
Redis:set(Theblac3k.."blac3k:Group:Link"..msg_chat_id,LinkGroup)
Redis:del(Theblac3k.."blac3k:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"📥︙تم حفظ الرابط بنجاح","md",true)         
end
end 
if Redis:get(Theblac3k.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(Theblac3k.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم الغاء حفظ الترحيب","md",true)   
end 
Redis:del(Theblac3k.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(Theblac3k.."blac3k:Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم حفظ ترحيب المجموعه","md",true)     
end
if Redis:get(Theblac3k.."blac3k:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(Theblac3k.."blac3k:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم الغاء حفظ القوانين","md",true)   
end 
Redis:set(Theblac3k.."blac3k:Group:Rules" .. msg_chat_id,text) 
Redis:del(Theblac3k.."blac3k:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم حفظ قوانين المجموعه","md",true)  
end  
if Redis:get(Theblac3k.."blac3k:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(Theblac3k.."blac3k:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
local test = Redis:get(Theblac3k.."blac3k:Text:Manager"..msg.sender.user_id..":"..msg_chat_id.."")
if Redis:get(Theblac3k.."blac3k:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(Theblac3k.."blac3k:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(Theblac3k.."blac3k:Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(Theblac3k.."blac3k:Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
end   
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Theblac3k.."blac3k:Add:Rd:Manager:Text"..test..msg_chat_id, text)  
end  
if msg.content.audio then
Redis:set(Theblac3k.."blac3k:Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(Theblac3k.."blac3k:Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  
end
if msg.content.animation then
Redis:set(Theblac3k.."blac3k:Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  
end
if msg.content.video_note then
Redis:set(Theblac3k.."blac3k:Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.video then
Redis:set(Theblac3k.."blac3k:Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  
end
if msg.content.photo then
...
print(idPhoto)
Redis:set(Theblac3k.."blac3k:Add:Rd:Manager:Photo"..test..msg_chat_id, idPhoto)  
end
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم حفظ رد للمدير بنجاح \n‹ : ارسل ( "..test.." ) لرئية الرد","md",true)  
end  
end
if text and text:match("^(.*)$") then
if Redis:get(Theblac3k.."blac3k:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(Theblac3k.."blac3k:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(Theblac3k.."blac3k:Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(Theblac3k.."blac3k:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(Theblac3k.."blac3k:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(Theblac3k.."blac3k:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(Theblac3k.."blac3k:Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(Theblac3k.."blac3k:Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(Theblac3k.."blac3k:Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(Theblac3k.."blac3k:Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(Theblac3k.."blac3k:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(Theblac3k.."blac3k:Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:sadd(Theblac3k.."blac3k:List:Manager"..msg_chat_id.."", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
{
{text = '🔖 ! 𝗦𝙤𝙪𝙧𝘤𝙚 Rocks :', url='https://t.me/ooo_od'},
},
}
}
...
if text and text:match("^(.*)$") then
if Redis:get(Theblac3k.."blac3k:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(Theblac3k.."blac3k:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(Theblac3k.."blac3k:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(Theblac3k.."blac3k:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(Theblac3k.."blac3k:Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(Theblac3k.."blac3k:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(Theblac3k.."blac3k:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(Theblac3k.."blac3k:List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم حذف الرد من ردود المدير ","md",true)  
return false
end
end
if text and Redis:get(Theblac3k.."blac3k:Status:ReplySudo"..msg_chat_id) then
local anemi = Redis:get(Theblac3k.."blac3k:Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(Theblac3k.."blac3k:Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(Theblac3k.."blac3k:Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(Theblac3k.."blac3k:Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(Theblac3k.."blac3k:Add:Rd:Sudo:Photo"..text)
local video = Redis:get(Theblac3k.."blac3k:Add:Rd:Sudo:Video"..text)
local document = Redis:get(Theblac3k.."blac3k:Add:Rd:Sudo:File"..text)
local audio = Redis:get(Theblac3k.."blac3k:Add:Rd:Sudo:Audio"..text)
local video_note = Redis:get(Theblac3k.."blac3k:Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(Theblac3k..'blac3k:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(Theblac3k..'blac3k:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
if text and Redis:get(Theblac3k.."blac3k:Status:Reply"..msg_chat_id) then
local anemi = Redis:get(Theblac3k.."blac3k:Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(Theblac3k.."blac3k:Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(Theblac3k.."blac3k:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(Theblac3k.."blac3k:Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(Theblac3k.."blac3k:Add:Rd:Manager:Photo"..text..msg_chat_id)
local video = Redis:get(Theblac3k.."blac3k:Add:Rd:Manager:Video"..text..msg_chat_id)
local document = Redis:get(Theblac3k.."blac3k:Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(Theblac3k.."blac3k:Add:Rd:Manager:Audio"..text..msg_chat_id)
local video_note = Redis:get(Theblac3k.."blac3k:Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(Theblac3k..'blac3k:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(Theblac3k.."blac3k:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(Theblac3k.."blac3k:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(Theblac3k.."blac3k:Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(Theblac3k.."blac3k:Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(Theblac3k.."blac3k:Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
end   
if msg.content.animation then   
Redis:set(Theblac3k.."blac3k:Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Theblac3k.."blac3k:Add:Rd:Sudo:Text"..test, text)  
end  
if msg.content.audio then
Redis:set(Theblac3k.."blac3k:Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(Theblac3k.."blac3k:Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  
end
if msg.content.video then
Redis:set(Theblac3k.."blac3k:Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  
end
if msg.content.video_note then
Redis:set(Theblac3k.."blac3k:Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
Redis:set(Theblac3k.."blac3k:Add:Rd:Sudo:Photo"..test, idPhoto)  
end
...
if text and text:match("^(.*)$") then
if Redis:get(Theblac3k.."blac3k:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(Theblac3k.."blac3k:Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(Theblac3k.."blac3k:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(Theblac3k.."blac3k:List:Rd:Sudo", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") then
if Redis:get(Theblac3k.."blac3k:Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
for k,v in pairs(list) do
Redis:del(Theblac3k..'blac3k:'..v..text)
end
Redis:del(Theblac3k.."blac3k:Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(Theblac3k.."blac3k:List:Rd:Sudo", text)
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم حذف الرد من ردود المطور","md",true)  
end
end
if Redis:get(Theblac3k.."blac3k:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(Theblac3k.."blac3k:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n‹ : تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(Theblac3k.."blac3k:ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
Redis:set(Theblac3k.."blac3k:PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
...
Redis:set(Theblac3k.."blac3k:PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(Theblac3k.."blac3k:PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(Theblac3k.."blac3k:PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(Theblac3k.."blac3k:PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(Theblac3k.."blac3k:PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(Theblac3k.."blac3k:PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(Theblac3k.."blac3k:PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
LuaTele.sendText(v,0,text,"md",true)
Redis:set(Theblac3k.."blac3k:PinMsegees:"..v,text)
end
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Theblac3k.."blac3k:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(Theblac3k.."blac3k:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n‹ : تم الغاء الاذاعه خاص","md",true)  
end 
local list = Redis:smembers(Theblac3k..'blac3k:Num:User:Pv')  
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Theblac3k.."blac3k:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(Theblac3k.."blac3k:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n‹ : تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(Theblac3k.."blac3k:ChekBotAdd") 
if msg.content.video_note then
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Theblac3k.."blac3k:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(Theblac3k.."blac3k:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Theblac3k.."blac3k:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(Theblac3k.."blac3k:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if text and Redis:get(Theblac3k..'blac3k:GetTexting:DevTheblac3k'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == 'الغاء الامر' then 
Redis:del(Theblac3k..'blac3k:GetTexting:DevTheblac3k'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'‹ : تم الغاء حفظ كليشة المطور')
end
Redis:set(Theblac3k..'blac3k:Texting:DevTheblac3k',text)
Redis:del(Theblac3k..'blac3k:GetTexting:DevTheblac3k'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'‹ : تم حفظ كليشة المطور')
end
if Redis:get(Theblac3k.."blac3k:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n‹ : تم الغاء امر تعين الايدي","md",true)  
Redis:del(Theblac3k.."blac3k:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(Theblac3k.."blac3k:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(Theblac3k.."blac3k:Set:Id:Group"..msg.chat_id,text:match("(.*)"))
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if Redis:get(Theblac3k.."blac3k:Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(Theblac3k.."blac3k:Change:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n‹ : تم الغاء امر تغير اسم البوت","md",true)  
end 
Redis:del(Theblac3k.."blac3k:Change:Name:Bot"..msg.sender.user_id) 
Redis:set(Theblac3k.."blac3k:Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "‹ :  تم تغير اسم البوت الى - "..text,"md",true)    
end 
if Redis:get(Theblac3k.."blac3k:Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(Theblac3k.."blac3k:Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n‹ : تم الغاء امر تغير كليشه start","md",true)  
end 
Redis:del(Theblac3k.."blac3k:Change:Start:Bot"..msg.sender.user_id) 
Redis:set(Theblac3k.."blac3k:Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "‹ :  تم تغيير كليشه start - "..text,"md",true)    
end 
if Redis:get(Theblac3k.."blac3k:Game:Smile"..msg.chat_id) then
if text == Redis:get(Theblac3k.."blac3k:Game:Smile"..msg.chat_id) then
Redis:incrby(Theblac3k.."blac3k:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Theblac3k.."blac3k:Game:Smile"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : لقد فزت في اللعبه \n‹ : اللعب مره اخره وارسل - سمايل او سمايلات","md",true)
end
end 
if Redis:get(Theblac3k.."Game:Countrygof"..msg.chat_id) then
if text == Redis:get(Theblac3k.."Game:Countrygof"..msg.chat_id) then
Redis:incrby(Theblac3k.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Theblac3k.."Game:Countrygof"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : لقد فزت في اللعبه \n‹ : العب مره اخره وارسل - اعلام","md",true)  
end
end
if Redis:get(Theblac3k.."mshaher"..msg.chat_id) then
if text == Redis:get(Theblac3k.."mshaher"..msg.chat_id) then
Redis:del(Theblac3k.."mshaher"..msg.chat_id)
Redis:incrby(Theblac3k.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : لقد فزت في اللعبه \n‹ : العب مره اخره وارسل - بوب او مشاهير","md",true)  
end
end
if Redis:get(Theblac3k.."Game:enkliz"..msg.chat_id) then
if text == Redis:get(Theblac3k.."Game:enkliz"..msg.chat_id) then
Redis:incrby(Theblac3k.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Theblac3k.."Game:enkliz"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : لقد فزت في اللعبه \n‹ : العب مره اخره وارسل - انجليزي","md",true)  
end
end
if Redis:get(Theblac3k.."blac3k:Game:Monotonous"..msg.chat_id) then
if text == Redis:get(Theblac3k.."blac3k:Game:Monotonous"..msg.chat_id) then
Redis:del(Theblac3k.."blac3k:Game:Monotonous"..msg.chat_id)
Redis:incrby(Theblac3k.."blac3k:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : لقد فزت في اللعبه \n‹ : اللعب مره اخره وارسل - الاسرع او ترتيب","md",true)  
end
end 
if Redis:get(Theblac3k.."blac3k:Game:Riddles"..msg.chat_id) then
if text == Redis:get(Theblac3k.."blac3k:Game:Riddles"..msg.chat_id) then
Redis:incrby(Theblac3k.."blac3k:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Theblac3k.."blac3k:Game:Riddles"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : لقد فزت في اللعبه \n‹ : اللعب مره اخره وارسل - حزوره","md",true)  
end
end
if Redis:get(Theblac3k.."blac3k:Game:Meaningof"..msg.chat_id) then
if text == Redis:get(Theblac3k.."blac3k:Game:Meaningof"..msg.chat_id) then
Redis:incrby(Theblac3k.."blac3k:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Theblac3k.."blac3k:Game:Meaningof"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : لقد فزت في اللعبه \n‹ : اللعب مره اخره وارسل - معاني","md",true)   
end
end
if Redis:get(Theblac3k.."blac3k:Game:Reflection"..msg.chat_id) then
if text == Redis:get(Theblac3k.."blac3k:Game:Reflection"..msg.chat_id) then
Redis:incrby(Theblac3k.."blac3k:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Theblac3k.."blac3k:Game:Reflection"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : لقد فزت في اللعبه \n‹ : اللعب مره اخره وارسل - العكس","md",true)  
end
end
if Redis:get(Theblac3k.."blac3k:Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(Theblac3k.."blac3k:Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(Theblac3k.."blac3k:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(Theblac3k.."blac3k:Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(Theblac3k.."blac3k:Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸︙تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(Theblac3k.."blac3k:SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(Theblac3k.."blac3k:SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(Theblac3k.."blac3k:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(Theblac3k.."blac3k:Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(Theblac3k.."blac3k:Game:Difference"..msg.chat_id) then
if text == Redis:get(Theblac3k.."blac3k:Game:Difference"..msg.chat_id) then 
Redis:del(Theblac3k.."blac3k:Game:Difference"..msg.chat_id)
Redis:incrby(Theblac3k.."blac3k:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(Theblac3k.."blac3k:Game:Example"..msg.chat_id) then
if text == Redis:get(Theblac3k.."blac3k:Game:Example"..msg.chat_id) then 
Redis:del(Theblac3k.."blac3k:Game:Example"..msg.chat_id)
Redis:incrby(Theblac3k.."blac3k:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ''..Redis:get(Theblac3k..'blac3k:Channel:Join:Name')..'', url = 't.me/'..Redis:get(Theblac3k..'blac3k:Channel:Join')}, },}}
...
if tonumber(Theblac3k) ~= tonumber(FilesJson.BotId) then
return LuaTele.sendText(msg_chat_id,msg_id,'‹ : عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end botid
...
Y = Y + 1
Redis:sadd(Theblac3k..'blac3k:Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(Theblac3k.."blac3k:ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(Theblac3k.."blac3k:TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(Theblac3k.."blac3k:Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(Theblac3k.."blac3k:Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(Theblac3k.."blac3k:Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(Theblac3k.."blac3k:Distinguished:Group"..GroupId,v)
end
end 
end
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(Theblac3k) then 
return LuaTele.sendText(msg_chat_id,msg_id,'‹ : عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
Redis:sadd(Theblac3k.."blac3k:ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(Theblac3k.."blac3k:Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(Theblac3k.."blac3k:Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(Theblac3k.."blac3k:Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(Theblac3k.."blac3k:TheBasics:Group"..idg,idASAS)
end;end
end
...
if (Redis:get(Theblac3k..'blac3k:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if (Redis:get(Theblac3k.."blac3k:AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == '『 الغاء الامر 』' then   
Redis:del(Theblac3k.."blac3k:AddSudosNew"..msg_chat_id)
...
Redis:set(Theblac3k.."blac3k:AddSudosNew"..msg_chat_id,true)
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ ارسل معرف المطور الاساسي مع @","md",true)
end
if text == 'الغاء' or text == 'الغاء الامر' then 
Redis:del(Theblac3k..'blac3k:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id)
...
if UserId_Info.type.is_channel == true then
local StatusMember = LuaTele.getChatMember(UserId_Info.id,Theblac3k).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,"\n•︙البوت عضو في القناة يرجى رفع البوت ادمن واعادة وضع الاشتراك ","md",true)  
end
Redis:set(Theblac3k..'blac3k:Channel:Join',ChannelUser) 
Redis:set(Theblac3k..'blac3k:Channel:Join:Name',UserId_Info.title) 
...
Redis:set(Theblac3k..'blac3k:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(Theblac3k..'blac3k:Channel:Join')
...
--os.execute('rm -rf blac3kbot.lua')
--download('https://raw.githubusercontent.com/SourceTheblac3k/Theblac3k/master/blac3kbot.lua','blac3kbot.lua')
...
local Groups = Redis:smembers(Theblac3k..'blac3k:ChekBotAdd')  
local UsersBot = Redis:smembers(Theblac3k..'blac3k:Num:User:Pv')  
local Get_Json = '{"BotId": '..Theblac3k..','  
if #UsersBot ~= 0 then 
...
local President = Redis:smembers(Theblac3k.."blac3k:TheBasics:Group"..v)
local Constructor = Redis:smembers(Theblac3k.."blac3k:Originators:Group"..v)
local Manager = Redis:smembers(Theblac3k.."blac3k:Managers:Group"..v)
local Admin = Redis:smembers(Theblac3k.."blac3k:Addictive:Group"..v)
local Vips = Redis:smembers(Theblac3k.."blac3k:Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
listrep = Redis:smembers(Theblac3k.."blac3k:List:Manager"..ide.."")
if k == 1 then
...
if Redis:get(Theblac3k.."blac3k:Add:Rd:Manager:Gif"..v..ide) then
db = "gif@"..Redis:get(Theblac3k.."blac3k:Add:Rd:Manager:Gif"..v..ide)
elseif Redis:get(Theblac3k.."blac3k:Add:Rd:Manager:Vico"..v..ide) then
db = "Vico@"..Redis:get(Theblac3k.."blac3k:Add:Rd:Manager:Vico"..v..ide)
elseif Redis:get(Theblac3k.."blac3k:Add:Rd:Manager:Stekrs"..v..ide) then
db = "Stekrs@"..Redis:get(Theblac3k.."blac3k:Add:Rd:Manager:Stekrs"..v..ide)
elseif Redis:get(Theblac3k.."blac3k:Add:Rd:Manager:Text"..v..ide) then
db = "Text@"..Redis:get(Theblac3k.."blac3k:Add:Rd:Manager:Text"..v..ide)
db = string.gsub(db,'"','')
db = string.gsub(db,"'",'')
db = string.gsub(db,'*','')
db = string.gsub(db,'`','')
...
db = string.gsub(db,'}','')
db = string.gsub(db,'\n',' ')
elseif Redis:get(Theblac3k.."blac3k:Add:Rd:Manager:Photo"..v..ide) then
db = "Photo@"..Redis:get(Theblac3k.."blac3k:Add:Rd:Manager:Photo"..v..ide) 
elseif Redis:get(Theblac3k.."blac3k:Add:Rd:Manager:Video"..v..ide) then
db = "Video@"..Redis:get(Theblac3k.."blac3k:Add:Rd:Manager:Video"..v..ide)
elseif Redis:get(Theblac3k.."blac3k:Add:Rd:Manager:File"..v..ide) then
db = "File@"..Redis:get(Theblac3k.."blac3k:Add:Rd:Manager:File"..v..ide)
elseif Redis:get(Theblac3k.."blac3k:Add:Rd:Manager:Audio"..v..ide) then
db = "Audio@"..Redis:get(Theblac3k.."blac3k:Add:Rd:Manager:Audio"..v..ide)
elseif Redis:get(Theblac3k.."blac3k:Add:Rd:Manager:video_note"..v..ide) then
db = "video_note@"..Redis:get(Theblac3k.."blac3k:Add:Rd:Manager:video_note"..v..ide)
end
v = string.gsub(v,'"','')
v = string.gsub(v,"'",'')
...
Redis:sadd(Theblac3k.."blac3k:List:Manager"..GroupId,k)
if v and v:match('gif@(.*)') then
Redis:set(Theblac3k.."blac3k:Add:Rd:Manager:Gif"..k..GroupId,v:match('gif@(.*)'))
elseif v and v:match('Vico@(.*)') then
Redis:set(Theblac3k.."blac3k:Add:Rd:Manager:Vico"..k..GroupId,v:match('Vico@(.*)'))
elseif v and v:match('Stekrs@(.*)') then
Redis:set(Theblac3k.."blac3k:Add:Rd:Manager:Stekrs"..k..GroupId,v:match('Stekrs@(.*)'))
elseif v and v:match('Text@(.*)') then
Redis:set(Theblac3k.."blac3k:Add:Rd:Manager:Text"..k..GroupId,v:match('Text@(.*)'))
elseif v and v:match('Photo@(.*)') then
Redis:set(Theblac3k.."blac3k:Add:Rd:Manager:Photo"..k..GroupId,v:match('Photo@(.*)'))
elseif v and v:match('Video@(.*)') then
Redis:set(Theblac3k.."blac3k:Add:Rd:Manager:Video"..k..GroupId,v:match('Video@(.*)'))
elseif v and v:match('File@(.*)') then
Redis:set(Theblac3k.."blac3k:Add:Rd:Manager:File"..k..GroupId,v:match('File@(.*)') )
elseif v and v:match('Audio@(.*)') then
Redis:set(Theblac3k.."blac3k:Add:Rd:Manager:Audio"..k..GroupId,v:match('Audio@(.*)'))
elseif v and v:match('video_note@(.*)') then
Redis:set(Theblac3k.."blac3k:Add:Rd:Manager:video_note"..k..GroupId,v:match('video_note@(.*)') )
end
end
end
end
...
Redis:set(Theblac3k..'blac3k:Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
LuaTele.sendText(msg_chat_id,msg_id,'*‹ : عدد احصائيات البوت الكامله \n— — — — — — — — —\n‹ : عدد المجموعات : '..(Redis:scard(Theblac3k..'blac3k:ChekBotAdd') or 0)..'\n‹ : عدد المشتركين : '..(Redis:scard(Theblac3k..'blac3k:Num:User:Pv') or 0)..'*',"md",true)  
end
...
if Redis:sismember(Theblac3k.."blac3k:ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(Theblac3k..'blac3k:Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,'‹ : عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(Theblac3k..'blac3k:Num:Add:Bot'),"md",true)  
end
...
Redis:sadd(Theblac3k.."blac3k:TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
end
end
end
Redis:sadd(Theblac3k.."blac3k:TheBasics:Group"..msg_chat_id,msg.sender.user_id) 
Redis:sadd(Theblac3k.."blac3k:ChekBotAdd",msg_chat_id)
Redis:set(Theblac3k.."blac3k:Status:Id"..msg_chat_id,true) ;Redis:set(Theblac3k.."blac3k:Status:Reply"..msg_chat_id,true) ;Redis:set(Theblac3k.."blac3k:Status:ReplySudo"..msg_chat_id,true) ;Redis:set(Theblac3k.."blac3k:Status:BanId"..msg_chat_id,true) ;Redis:set(Theblac3k.."blac3k:Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(Theblac3k.."blac3k:BotFree") then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(Theblac3k.."blac3k:ChekBotAdd",msg_chat_id) then
...
Redis:srem(Theblac3k.."blac3k:ChekBotAdd",msg_chat_id)
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(Theblac3k.."blac3k:ChekBotAdd",msg_chat_id) then
...
{
{text = ' S𝘰𝘶𝘳𝘤𝘦 Rocks ⁦ᯓ ',url="https://t.me/ooo_od"}
},
}
}
...
Redis:del(Theblac3k..'Abs:gif:Abs'..msg.chat_id) 
end
...
local F333F = ' \n‹ : تم تعطيل المتحركه'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(Theblac3k..'Abs:gif:Abs'..msg.chat_id,true)  
end
if text and (text == "متحركه" or text == "↫ متحركه ✯") and not Redis:get(Theblac3k..'Abs:gif:Abs'..msg.chat_id) then
...
local F333F = ' \n‹ : تم تفعيل الميمز'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(Theblac3k..'Abs:memz:Abs'..msg.chat_id) 
end
...
local F333F = ' \n‹ : تم تعطيل الميمز'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(Theblac3k..'Abs:memz:Abs'..msg.chat_id,true)  
end
if text and (text == "ميمز" or text == "↫ ميمز ✯") and not Redis:get(Theblac3k..'Abs:memz:Abs'..msg.chat_id) then
...
local F333F = ' \n‹ : تم تفعيل الريمكس'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(Theblac3k..'Abs:Remix:Abs'..msg.chat_id) 
end
...
local F333F = ' \n‹ : تم تعطيل الريمكس'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(Theblac3k..'Abs:Remix:Abs'..msg.chat_id,true)  
end
...
local F333F = ' \n‹ : تم تفعيل الصوره'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(Theblac3k..'Abs:Photo:Abs'..msg.chat_id) 
end
...
local F333F = ' \n‹ : تم تعطيل الصوره'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(Theblac3k..'Abs:Photo:Abs'..msg.chat_id,true)  
end
if text and (text == "صوره" or text == "↫ صوره ✯") and not Redis:get(Theblac3k..'Abs:Photo:Abs'..msg.chat_id) then
...
local F333F = ' \n‹ : تم تفعيل الانمي'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(Theblac3k..'Abs:Anime:Abs'..msg.chat_id) 
end
...
local F333F = ' \n‹ : تم تعطيل الانمي'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(Theblac3k..'Abs:Anime:Abs'..msg.chat_id,true)  
end
if text and (text == "انمي" or text == "↫ انمي ✯") and not Redis:get(Theblac3k..'Abs:Anime:Abs'..msg.chat_id) then
...
local F333F = ' \n‹ : تم تفعيل الافلام'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(Theblac3k..'Abs:Movies:Abs'..msg.chat_id) 
end
...
local F333F = ' \n‹ : تم تعطيل الافلام'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(Theblac3k..'Abs:Movies:Abs'..msg.chat_id,true)  
end
if text and (text == "فلم" or text == "↫ فلم ✯") and not Redis:get(Theblac3k..'Abs:Movies:Abs'..msg.chat_id) then
...
local F333F = ' \n‹ : تم تفعيل المسلسلات'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(Theblac3k..'Abs:Series:Abs'..msg.chat_id) 
end
...
local F333F = ' \n‹ : تم تعطيل المسلسلات'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(Theblac3k..'Abs:Series:Abs'..msg.chat_id,true)  
end
if text and (text == "مسلسل" or text == "↫ مسلسل ✯") and not Redis:get(Theblac3k..'Abs:Series:Abs'..msg.chat_id) then
...
if text == 'بايو' and not Redis:get(Theblac3k..'idnotmembio'..msg.chat_id)  then
...
if Redis:get(Theblac3k..'idnotmembio'..msg.chat_id)  then
LuaTele.sendText(msg_chat_id,msg_id, '‹ : تم تعطيل امر البايو مسبقا\n ✓',"md")
else
Redis:set(Theblac3k.."idnotmembio"..msg.chat_id,"true")
...
if not Redis:get(Theblac3k..'idnotmembio'..msg.chat_id)  then
LuaTele.sendText(msg_chat_id,msg_id, '‹ : تم تفعيل امر البايو مسبقا\n ✓',"md")
else
Redis:del(Theblac3k.."idnotmembio"..msg.chat_id)
LuaTele.sendText(msg_chat_id,msg_id, '‹ : تم تفعيل امر البايو \n ✓',"md")
end
end
if Redis:get(Theblac3k..":"..msg.sender.user_id..":lov_Bots"..msg.chat_id) == "sendlove" then
...
Redis:del(Theblac3k..":"..msg.sender.user_id..":lov_Bots"..msg.chat_id)
end
if Redis:get(Theblac3k..":"..msg.sender.user_id..":lov_Bottts"..msg.chat_id) == "sendlove" then
num = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnum = num[math.random(#num)]
local tttttt = '‹ : اليك النتائج الخـاصة :\n\n‹ : نسبة الغباء  : *'..text..'* '..sendnum..'%'
LuaTele.sendText(msg_chat_id,msg_id,tttttt) 
Redis:del(Theblac3k..":"..msg.sender.user_id..":lov_Bottts"..msg.chat_id)
end
if Redis:get(Theblac3k..":"..msg.sender.user_id..":lov_Botttuus"..msg.chat_id) == "sendlove" then
num = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnum = num[math.random(#num)]
local tttttt = '‹ : اليك النتائج الخـاصة :\n\n‹ : نسبة الذكاء  : *'..text..'* '..sendnum..'%'
LuaTele.sendText(msg_chat_id,msg_id,tttttt) 
Redis:del(Theblac3k..":"..msg.sender.user_id..":lov_Botttuus"..msg.chat_id)
end
if text and Redis:get(Theblac3k..":"..msg.sender.user_id..":krh_Bots"..msg.chat_id) == "sendkrhe" then
num = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnum = num[math.random(#num)]
local tttttt = '⌯ اليك النتائج الخـاصة :\n\n⌯ نسبه الكرة : *'..text..'* '..sendnum..'%'
LuaTele.sendText(msg_chat_id,msg_id,tttttt) 
Redis:del(Theblac3k..":"..msg.sender.user_id..":krh_Bots"..msg.chat_id)
end
if text and text ~="نسبه الرجوله" and Redis:get(Theblac3k..":"..msg.sender.user_id..":rjo_Bots"..msg.chat_id) == "sendrjoe" then
numj = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","🥰 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnuj = numj[math.random(#numj)]
local tttttt = '‹ : اليك النتائج الخـاصة :\n\n‹ :  نسبة الرجوله لـ : *'..text..'* '..sendnuj..'%'
LuaTele.sendText(msg_chat_id,msg_id,tttttt) 
Redis:del(Theblac3k..":"..msg.sender.user_id..":rjo_Bots"..msg.chat_id)
end
if text and text ~="نسبه الانوثه" and Redis:get(Theblac3k..":"..msg.sender.user_id..":ano_Bots"..msg.chat_id) == "sendanoe" then
numj = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","?? 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnuj = numj[math.random(#numj)]
local tttttt = '‹ : اليك النتائج الخـاصة :\n\n‹ :  نسبه الانوثة لـ : *'..text..'* '..sendnuj..'%'
LuaTele.sendText(msg_chat_id,msg_id,tttttt) 
Redis:del(Theblac3k..":"..msg.sender.user_id..":ano_Bots"..msg.chat_id)
end

if text == "نسبه الحب" or text == "نسبه حب" and msg.reply_to_message_id ~= 0 then
if not Redis:get(Theblac3k.."AlNsb"..msg.chat_id) then    
Redis:set(Theblac3k..":"..msg.sender.user_id..":lov_Bots"..msg.chat_id,"sendlove")
...
if not Redis:get(Theblac3k.."AlNsb"..msg.chat_id) then    
Redis:set(Theblac3k..":"..msg.sender.user_id..":lov_Bottts"..msg.chat_id,"sendlove")
...
if not Redis:get(Theblac3k.."AlNsb"..msg.chat_id) then    
Redis:set(Theblac3k..":"..msg.sender.user_id..":lov_Botttuus"..msg.chat_id,"sendlove")
hggg = '‹ : الان ارسل اسم الشخص :'
LuaTele.sendText(msg_chat_id,msg_id,hggg) 
return false
end
...
if not Redis:get(Theblac3k.."AlNsb"..msg.chat_id) then    
Redis:set(Theblac3k..":"..msg.sender.user_id..":krh_Bots"..msg.chat_id,"sendkrhe")
hggg = '‹ : الان ارسل اسمك واسم الشخص الثاني :'
LuaTele.sendText(msg_chat_id,msg_id,hggg) 
return false
end
...
if not Redis:get(Theblac3k.."AlNsb"..msg.chat_id) then    
Redis:set(Theblac3k..":"..msg.sender.user_id..":rjo_Bots"..msg.chat_id,"sendrjoe")
hggg = '‹ : الان ارسل اسم الشخص :'
LuaTele.sendText(msg_chat_id,msg_id,hggg) 
return false
end
...
if not Redis:get(Theblac3k.."AlNsb"..msg.chat_id) then    
Redis:set(Theblac3k..":"..msg.sender.user_id..":ano_Bots"..msg.chat_id,"sendanoe")
hggg = '‹ : الان ارسل اسم الشخص :'
LuaTele.sendText(msg_chat_id,msg_id,hggg) 
return false
end
...
if Redis:get(Theblac3k..'AlNsb'..msg.chat_id)  then
return LuaTele.sendText(msg_chat_id,msg_id,'‹ : تم تعطيل النسب مسبقا\n ✓',"md")
else
Redis:set(Theblac3k.."AlNsb"..msg.chat_id,"true")
...
Redis:del(Theblac3k.."AlNsb"..msg.chat_id)
...
if Redis:get(Theblac3k..'myphoto'..msg.chat_id)  then
return LuaTele.sendText(msg_chat_id,msg_id,'‹ : تم تعطيل صورتي مسبقا\n ✓',"md")
else
Redis:set(Theblac3k.."myphoto"..msg.chat_id,"off")
...
if not Redis:get(Theblac3k..'myphoto'..msg.chat_id)  then
return LuaTele.sendText(msg_chat_id,msg_id,'‹ : تم تفعيل صورتي مسبقا\n ✓',"md")
else
Redis:del(Theblac3k.."myphoto"..msg.chat_id)
...
Redis:del(Theblac3k.."mybuti"..msg_chat_id)
...
Redis:set(Theblac3k.."mybuti"..msg_chat_id,"off")
...
Redis:del(Theblac3k.."sayy"..msg_chat_id)
...
Redis:set(Theblac3k.."sayy"..msg_chat_id,"off")
LuaTele.sendText(msg_chat_id,msg_id,'\n*‹ : تم امر امر كول * ',"md",true)  
end
if text == "جمالي" or text == 'نسبه جمالي' then
if Redis:get(Theblac3k.."mybuti"..msg_chat_id) == "off" then
...
if Redis:get(Theblac3k.."sayy"..msg_chat_id) == "off" then
...
if text == "صورتي" then
if Redis:get(Theblac3k.."myphoto"..msg_chat_id) == "off" then
...
Redis:set(Theblac3k.."blac3k:Set:Id:Group"..msg.chat_id,Text_Rand)
...
if not Redis:get(Theblac3k.."blac3k:Status:Id"..msg_chat_id) then
return false
end
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
...
local TotalMsg = Redis:get(Theblac3k..'blac3k:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(Theblac3k..'blac3k:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(Theblac3k.."blac3k:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(Theblac3k.."blac3k:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
local Texting = {
'صورتك فدشي خيالي',
"شتحس مخلي هلصورا ؟ ",
"محتحت اقسم",
...
Get_Is_Id = Redis:get(Theblac3k.."blac3k:Set:Id:Group"..msg_chat_id)
if Redis:get(Theblac3k.."blac3k:Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
...
local TotalMsg = Redis:get(Theblac3k..'blac3k:Num:Message:User'..msg_chat_id..':'..Message_Reply.sender.user_id) or 0
local TotalEdit = Redis:get(Theblac3k..'blac3k:Num:Message:Edit'..msg_chat_id..Message_Reply.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*‹ : ايديه : '..UserId..
...
local TotalMsg = Redis:get(Theblac3k..'blac3k:Num:Message:User'..msg_chat_id..':'..UserId_Info.id) or 0
local TotalEdit = Redis:get(Theblac3k..'blac3k:Num:Message:Edit'..msg_chat_id..UserId_Info.id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*‹ : ايديه : '..UserId..
'\n‹ : معرفه : @'..UserName..
...
local StatusMember = LuaTele.getChatMember(msg_chat_id,Theblac3k).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,'‹ : البوت عضو في المجموعه ',"md",true) 
end
local GetMemberStatus = LuaTele.getChatMember(msg_chat_id,Theblac3k).status
if GetMemberStatus.can_change_info then
change_info = '❬ ✔️ ❭' else change_info = '❬ ❌ ❭'
end
if GetMemberStatus.can_delete_messages then
...
if not Redis:sismember(Theblac3k.."blac3k:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:srem(Theblac3k.."blac3k:DevelopersQ:Groups",UserId_Info.id) 
...
if not Redis:sismember(Theblac3k.."blac3k:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(Theblac3k.."blac3k:Developers:Groups",UserId_Info.id) 
...
if not Redis:sismember(Theblac3k.."blac3k:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(Theblac3k.."blac3k:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Theblac3k.."blac3k:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(Theblac3k.."blac3k:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Theblac3k.."blac3k:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(Theblac3k.."blac3k:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Theblac3k.."blac3k:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(Theblac3k.."blac3k:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Theblac3k.."blac3k:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(Theblac3k.."blac3k:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Theblac3k.."blac3k:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(Theblac3k.."blac3k:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Theblac3k.."blac3k:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(Theblac3k.."blac3k:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Theblac3k.."blac3k:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(Theblac3k.."blac3k:Developers:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Theblac3k.."blac3k:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(Theblac3k.."blac3k:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Theblac3k.."blac3k:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Theblac3k.."blac3k:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Theblac3k.."blac3k:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Theblac3k.."blac3k:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Theblac3k.."blac3k:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Theblac3k.."blac3k:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Theblac3k.."blac3k:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Theblac3k.."blac3k:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Theblac3k.."blac3k:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Theblac3k.."blac3k:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Theblac3k.."blac3k:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"‹ : تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:srem(Theblac3k.."blac3k:DevelopersQ:Groups",UserId) 
...
if not Redis:sismember(Theblac3k.."blac3k:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"‹ : تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(Theblac3k.."blac3k:Developers:Groups",UserId) 
...
if not Redis:sismember(Theblac3k.."blac3k:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(Theblac3k.."blac3k:TheBasicsW:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Theblac3k.."blac3k:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(Theblac3k.."blac3k:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Theblac3k.."blac3k:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(Theblac3k.."blac3k:Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Theblac3k.."blac3k:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(Theblac3k.."blac3k:Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Theblac3k.."blac3k:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(Theblac3k.."blac3k:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Theblac3k.."blac3k:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(Theblac3k.."blac3k:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Theblac3k.."blac3k:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم ترقيته مطوࢪ بنجاح ☑ ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(Theblac3k.."blac3k:DevelopersQ:Groups",UserId_Info.id) 
...
if Redis:sismember(Theblac3k.."blac3k:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم ترقيته مطوࢪ بنجاح ☑ مسبقا ").Reply,"md",true)  
else
Redis:sadd(Theblac3k.."blac3k:Developers:Groups",UserId_Info.id) 
...
if Redis:sismember(Theblac3k.."blac3k:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(Theblac3k.."blac3k:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Theblac3k.."blac3k:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
...
Redis:sadd(Theblac3k.."blac3k:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Theblac3k.."blac3k:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم ترقيته منشئ بنجاح ☑ مسبقا ").Reply,"md",true)  
else
Redis:sadd(Theblac3k.."blac3k:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Theblac3k.."blac3k:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم ترقيته مدير مسبقآ ☑ ").Reply,"md",true)  
else
Redis:sadd(Theblac3k.."blac3k:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not msg.Originators and not Redis:get(Theblac3k.."blac3k:Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(Theblac3k.."blac3k:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم ترقيته ادمن مسبقآ ☑ ").Reply,"md",true)  
else
Redis:sadd(Theblac3k.."blac3k:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Theblac3k.."blac3k:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم ترقيته مميز مسبقآ ☑ ").Reply,"md",true)  
else
Redis:sadd(Theblac3k.."blac3k:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Theblac3k.."blac3k:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(Theblac3k.."blac3k:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Theblac3k.."blac3k:Developers:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(Theblac3k.."blac3k:Developers:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Theblac3k.."blac3k:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(Theblac3k.."blac3k:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Theblac3k.."blac3k:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Theblac3k.."blac3k:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم ترقيته منشئ اساسي بنجاح ☑").Reply,"md",true)  
end
end
if TextMsg == "منشئ" then
...
if Redis:sismember(Theblac3k.."blac3k:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Theblac3k.."blac3k:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Theblac3k.."blac3k:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم ترقيته مدير مسبقآ ☑ ").Reply,"md",true)  
else
Redis:sadd(Theblac3k.."blac3k:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Theblac3k.."blac3k:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم ترقيته ادمن مسبقآ ☑ ").Reply,"md",true)  
else
Redis:sadd(Theblac3k.."blac3k:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Theblac3k.."blac3k:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم ترقيته مميز مسبقآ ☑ ").Reply,"md",true)  
else
Redis:sadd(Theblac3k.."blac3k:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Theblac3k.."blac3k:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"‹ : تم ترقيته مطوࢪ بنجاح ☑ ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(Theblac3k.."blac3k:DevelopersQ:Groups",UserId) 
...
if Redis:sismember(Theblac3k.."blac3k:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"‹ : تم ترقيته مطوࢪ بنجاح ☑ مسبقا ").Reply,"md",true)  
else
Redis:sadd(Theblac3k.."blac3k:Developers:Groups",UserId) 
...
if Redis:sismember(Theblac3k.."blac3k:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(Theblac3k.."blac3k:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Theblac3k.."blac3k:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم ترقيته منشئ بنجاح ☑اساسي بنجاح ☑ مسبقا ").Reply,"md",true)  
else
Redis:sadd(Theblac3k.."blac3k:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Theblac3k.."blac3k:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم ترقيته منشئ بنجاح ☑ مسبقا ").Reply,"md",true)  
else
Redis:sadd(Theblac3k.."blac3k:Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Theblac3k.."blac3k:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم ترقيته مدير مسبقآ ☑ ").Reply,"md",true)  
else
Redis:sadd(Theblac3k.."blac3k:Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Theblac3k.."blac3k:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم ترقيته ادمن مسبقآ ☑ ").Reply,"md",true)  
else
Redis:sadd(Theblac3k.."blac3k:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Theblac3k.."blac3k:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم ترقيته مميز مسبقآ ☑ ").Reply,"md",true)  
else
Redis:sadd(Theblac3k.."blac3k:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(Theblac3k.."blac3k:Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(Theblac3k.."blac3k:President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Theblac3k.."blac3k:Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Theblac3k.."blac3k:Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(Theblac3k.."blac3k:Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Theblac3k.."blac3k:Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(Theblac3k.."blac3k:DevelopersQ:Groups") 
...
local Info_Members = Redis:smembers(Theblac3k.."blac3k:Developers:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : لا يوجد مطورين حاليا , ","md",true)  
end
ListMembers = '\n*‹ : قائمه مطورين البوت \n — — — — — — — — —*\n'
...
local Info_Members = Redis:smembers(Theblac3k.."blac3k:TheBasicsQ:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Theblac3k.."blac3k:TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : لا يوجد منشئين اساسيين حاليا , ","md",true)  
end
...
local Info_Members = Redis:smembers(Theblac3k.."blac3k:Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Theblac3k.."blac3k:Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Theblac3k.."blac3k:Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Theblac3k.."blac3k:Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Theblac3k.."blac3k:BanAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Theblac3k.."blac3k:BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Theblac3k.."blac3k:SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(Theblac3k.."blac3k:Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم تفعيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(Theblac3k.."blac3k:Status:Welcome"..msg_chat_id,true) 
...
Redis:set(Theblac3k.."blac3k:Status:Id"..msg_chat_id,true) 
...
Redis:set(Theblac3k.."blac3k:Status:IdPhoto"..msg_chat_id,true) 
...
Redis:set(Theblac3k.."blac3k:Status:Reply"..msg_chat_id,true) 
...
Redis:set(Theblac3k.."blac3k:Status:ReplySudo"..msg_chat_id,true) 
...
Redis:set(Theblac3k.."blac3k:Status:BanId"..msg_chat_id,true) 
...
Redis:set(Theblac3k.."blac3k:BotFree",true) 
...
Redis:set(Theblac3k.."blac3k:TwaslBot",true) 
...
if text and text:match("^(.*)$") then
if Redis:get(Theblac3k.."blac3k1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(Theblac3k.."blac3k1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(Theblac3k.."blac3k1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(Theblac3k.."blac3k1:List:Rd:Sudo"..msg.chat_id, text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") then
if Redis:get(Theblac3k.."blac3k1:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:del(Theblac3k..'blac3k1:Add:Rd:Sudo:Text'..text..msg.chat_id)
Redis:del(Theblac3k..'blac3k1:Add:Rd:Sudo:Text1'..text..msg.chat_id)
Redis:del(Theblac3k..'blac3k1:Add:Rd:Sudo:Text2'..text..msg.chat_id)
Redis:del(Theblac3k.."blac3k1:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(Theblac3k.."blac3k1:List:Rd:Sudo"..msg.chat_id, text)
...
local list = Redis:smembers(Theblac3k.."blac3k1:List:Rd:Sudo"..msg.chat_id)
for k,v in pairs(list) do  
Redis:del(Theblac3k.."blac3k1:Add:Rd:Sudo:Text"..v..msg.chat_id) 
Redis:del(Theblac3k.."blac3k1:Add:Rd:Sudo:Text1"..v..msg.chat_id) 
Redis:del(Theblac3k.."blac3k1:Add:Rd:Sudo:Text2"..v..msg.chat_id) 
Redis:del(Theblac3k.."blac3k1:List:Rd:Sudo"..msg.chat_id)
end
...
Redis:set(Theblac3k.."blac3k1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(Theblac3k.."blac3k1:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(Theblac3k.."blac3k1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Theblac3k.."blac3k1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(Theblac3k.."blac3k1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Theblac3k.."blac3k1:Add:Rd:Sudo:Text"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(Theblac3k.."blac3k1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Theblac3k.."blac3k1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(Theblac3k.."blac3k1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Theblac3k.."blac3k1:Add:Rd:Sudo:Text1"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(Theblac3k.."blac3k1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Theblac3k.."blac3k1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(Theblac3k.."blac3k1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Theblac3k.."blac3k1:Add:Rd:Sudo:Text2"..test..msg.chat_id, text)  
end  
...
if text then
local Text = Redis:get(Theblac3k.."blac3k1:Add:Rd:Sudo:Text"..text..msg.chat_id)   
local Text1 = Redis:get(Theblac3k.."blac3k1:Add:Rd:Sudo:Text1"..text..msg.chat_id)   
local Text2 = Redis:get(Theblac3k.."blac3k1:Add:Rd:Sudo:Text2"..text..msg.chat_id)   
...
if text and text:match("^(.*)$") then
if Redis:get(Theblac3k.."blac3k11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ')
Redis:set(Theblac3k.."blac3k11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(Theblac3k.."blac3k11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(Theblac3k.."blac3k11:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if Redis:get(Theblac3k.."blac3k11:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف الرد من ردود المتعدده")
Redis:del(Theblac3k..'blac3k11:Add:Rd:Sudo:Text'..text)
Redis:del(Theblac3k..'blac3k11:Add:Rd:Sudo:Text1'..text)
Redis:del(Theblac3k..'blac3k11:Add:Rd:Sudo:Text2'..text)
Redis:del(Theblac3k.."blac3k11:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(Theblac3k.."blac3k11:List:Rd:Sudo", text)
return false
end
end
...
local list = Redis:smembers(Theblac3k.."blac3k11:List:Rd:Sudo")
for k,v in pairs(list) do  
Redis:del(Theblac3k.."blac3k11:Add:Rd:Sudo:Text"..v) 
Redis:del(Theblac3k.."blac3k11:Add:Rd:Sudo:Text1"..v) 
Redis:del(Theblac3k.."blac3k11:Add:Rd:Sudo:Text2"..v)   
Redis:del(Theblac3k.."blac3k11:List:Rd:Sudo")
end
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف ردود المتعدده")
end
...
Redis:set(Theblac3k.."blac3k11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الرد الذي اريد اضافته")
end
...
Redis:set(Theblac3k.."blac3k11:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(Theblac3k.."blac3k11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Theblac3k.."blac3k11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(Theblac3k.."blac3k11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Theblac3k.."blac3k11:Add:Rd:Sudo:Text"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الاول ارسل الرد الثاني")
return false  
end  
...
if text then  
local test = Redis:get(Theblac3k.."blac3k11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Theblac3k.."blac3k11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(Theblac3k.."blac3k11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Theblac3k.."blac3k11:Add:Rd:Sudo:Text1"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
...
if text then  
local test = Redis:get(Theblac3k.."blac3k11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Theblac3k.."blac3k11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(Theblac3k.."blac3k11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Theblac3k.."blac3k11:Add:Rd:Sudo:Text2"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد")
return false  
end  
...
if text then
local Text = Redis:get(Theblac3k.."blac3k11:Add:Rd:Sudo:Text"..text)   
local Text1 = Redis:get(Theblac3k.."blac3k11:Add:Rd:Sudo:Text1"..text)   
local Text2 = Redis:get(Theblac3k.."blac3k11:Add:Rd:Sudo:Text2"..text)   
if Text or Text1 or Text2 then 
local texting = {
Text,
Text1,
...
Redis:sadd(Theblac3k.."blac3k:allM"..msg.chat_id, msg.id)
if Redis:get(Theblac3k.."blac3k:Status:Del:Media"..msg.chat_id) then    
local gmedia = Redis:scard(Theblac3k.."blac3k:allM"..msg.chat_id)  
if gmedia >= 200 then
local liste = Redis:smembers(Theblac3k.."blac3k:allM"..msg.chat_id)
...
Redis:del(Theblac3k.."blac3k:allM"..msg.chat_id)
end
end
end
...
local list = Redis:smembers(Theblac3k.."blac3k:allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = Redis:scard(Theblac3k.."blac3k:allM"..msg.chat_id)  
...
Redis:del(Theblac3k.."blac3k:Status:Del:Media"..msg.chat_id)
...
Redis:set(Theblac3k.."blac3k:Status:Del:Media"..msg.chat_id,true)
...
Redis:del(Theblac3k.."blac3k:Status:yt"..msg.chat_id)
...
Redis:set(Theblac3k.."blac3k:Status:yt"..msg.chat_id,true)
LuaTele.sendText(msg_chat_id,msg_id,'‹ : تم تفعيل اليوتيوب')
return false
end 
if text and text:match('^بحث (.*)$') and Redis:get(Theblac3k.."blac3k:Status:yt"..msg.chat_id) then
...
{
{text = '🔖 ! 𝗦𝙤𝙪𝙧𝘤𝙚 Rocks :',url="t.me/ooo_od"}
},
{
...
{
{text = '- ??𝘯𝘢𝘱 𝖲𝗈𝗎𝗋𝖼𝖾 .', url='https://t.me/ooo_od'},
},
}
local msg_id = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
{{text = 'Delete Instagram',url="https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/"},{text = 'Delete blac3kchat',url="https://accounts.blac3kchat.com/accounts/login?continue=https%3A%2F%2Faccounts.blac3kchat.com%2Faccounts%2Fdeleteaccount"}},{{text= '❲ 𝘴????𝘱 𝖲𝗈𝗎𝗋𝖼𝖾 ❳',url="t.me/ooo_od"}}
}
local msg_id = msg.id/2097152/0.5
...
keyboard.inline_keyboard = {
{
{text = ' S𝘰𝘶𝘳𝘤𝘦 Rocks ⁦ᯓ ',url="https://t.me/ooo_od"},{text = ' U𝘱 𝘥𝘢𝘵𝘦𝘴 ᯓ ',url="https://t.me/X_GGX"}
},
{
{text = ' مطور السورس ⁦ᯓ ',url="https://t.me/X_GGX"}
},
}
local msg_id = msg.id/2097152/0.5
...
Redis:del(Theblac3k.."blac3k:Status:joinet"..msg_chat_id) 
...
Redis:set(Theblac3k.."blac3k:Status:joinet"..msg_chat_id,true) 
...
if TextMsg == 'الرابط' then
Redis:del(Theblac3k.."blac3k:Status:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم تعطيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(Theblac3k.."blac3k:Status:Welcome"..msg_chat_id) 
...
Redis:del(Theblac3k.."blac3k:Status:Id"..msg_chat_id) 
...
Redis:del(Theblac3k.."blac3k:Status:IdPhoto"..msg_chat_id) 
...
Redis:del(Theblac3k.."blac3k:Status:Reply"..msg_chat_id) 
...
Redis:del(Theblac3k.."blac3k:Status:ReplySudo"..msg_chat_id) 
...
Redis:del(Theblac3k.."blac3k:Status:BanId"..msg_chat_id) 
...
Redis:del(Theblac3k.."blac3k:Status:SetId"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم تعطيل الرفع ","md",true)
end
if TextMsg == 'الالعاب' then
Redis:del(Theblac3k.."blac3k:Status:Games"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم تعطيل الالعاب ","md",true)
end
if TextMsg == 'اطردني' then
Redis:del(Theblac3k.."blac3k:Status:KickMe"..msg_chat_id) 
...
Redis:del(Theblac3k.."blac3k:BotFree") 
...
Redis:del(Theblac3k.."blac3k:TwaslBot") 
...
if Redis:sismember(Theblac3k.."blac3k:BanAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(Theblac3k.."blac3k:BanAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(Theblac3k.."blac3k:BanAll:Groups",UserId_Info.id) then
...
Redis:srem(Theblac3k.."blac3k:BanAll:Groups",UserId_Info.id) 
...
if not msg.Originators and not Redis:get(Theblac3k.."blac3k:Status:BanId"..msg_chat_id) then
...
if Redis:sismember(Theblac3k.."blac3k:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
Redis:sadd(Theblac3k.."blac3k:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
...
if not Redis:sismember(Theblac3k.."blac3k:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(Theblac3k.."blac3k:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(Theblac3k.."blac3k:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
Redis:sadd(Theblac3k.."blac3k:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if not Redis:sismember(Theblac3k.."blac3k:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(Theblac3k.."blac3k:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(Theblac3k.."blac3k:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(Theblac3k.."blac3k:BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Theblac3k.."blac3k:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(Theblac3k.."blac3k:BanAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Theblac3k.."blac3k:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Theblac3k.."blac3k:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if not Redis:sismember(Theblac3k.."blac3k:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Theblac3k.."blac3k:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(Theblac3k.."blac3k:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Theblac3k.."blac3k:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Theblac3k.."blac3k:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Theblac3k.."blac3k:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if ChannelJoin(msg) == false then
local chinfo = Redis:get(Theblac3k.."ch:admin")
...
if Redis:sismember(Theblac3k.."blac3k:BanAll:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"‹ : تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(Theblac3k.."blac3k:BanAll:Groups",UserId) 
...
if not Redis:sismember(Theblac3k.."blac3k:BanAll:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"‹ : تم الغاء حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:srem(Theblac3k.."blac3k:BanAll:Groups",UserId) 
...
if Redis:sismember(Theblac3k.."blac3k:BanGroup:Group"..msg_chat_id,UserId) then
...
Redis:sadd(Theblac3k.."blac3k:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
...
if not Redis:sismember(Theblac3k.."blac3k:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"‹ : تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(Theblac3k.."blac3k:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(Theblac3k.."blac3k:SilentGroup:Group"..msg_chat_id,UserId) then
...
Redis:sadd(Theblac3k.."blac3k:SilentGroup:Group"..msg_chat_id,UserId) 
...
if not Redis:sismember(Theblac3k.."blac3k:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"‹ : تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(Theblac3k.."blac3k:SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"‹ : تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if not Redis:get(Theblac3k.."blac3k:Status:KickMe"..msg_chat_id) then
...
Redis:sadd(Theblac3k.."blac3k:Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
Redis:set(Theblac3k.."blac3k:Lock:text"..msg_chat_id,true) 
...
Redis:set(Theblac3k.."blac3k:Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(Theblac3k.."blac3k:Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(Theblac3k.."blac3k:Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(Theblac3k.."blac3k:Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(Theblac3k.."blac3k:Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(Theblac3k.."blac3k:lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(Theblac3k.."blac3k:Lock:edit"..msg_chat_id,true) 
...
Redis:set(Theblac3k.."blac3k:Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(Theblac3k..'blac3k:'..lock..msg_chat_id,"del")    
end
...
Redis:del(Theblac3k.."blac3k:Lock:AddMempar"..msg_chat_id)  
...
Redis:del(Theblac3k.."blac3k:Lock:text"..msg_chat_id)  
...
Redis:del(Theblac3k.."blac3k:Lock:Join"..msg_chat_id)  
...
Redis:del(Theblac3k.."blac3k:Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(Theblac3k.."blac3k:Lock:tagservr"..msg_chat_id)  
...
Redis:del(Theblac3k.."blac3k:lockpin"..msg_chat_id)  
...
Redis:del(Theblac3k.."blac3k:Lock:edit"..msg_chat_id) 
...
Redis:del(Theblac3k.."blac3k:Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(Theblac3k..'blac3k:'..lock..msg_chat_id)    
end
...
Redis:hset(Theblac3k.."blac3k:Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(Theblac3k.."blac3k:Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(Theblac3k.."blac3k:Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(Theblac3k.."blac3k:Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(Theblac3k.."blac3k:Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(Theblac3k.."blac3k:Lock:Link"..msg_chat_id,"del")  
...
Redis:set(Theblac3k.."blac3k:Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(Theblac3k.."blac3k:Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(Theblac3k.."blac3k:Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(Theblac3k.."blac3k:Lock:Link"..msg_chat_id)  
...
Redis:set(Theblac3k.."blac3k:Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(Theblac3k.."blac3k:Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(Theblac3k.."blac3k:Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(Theblac3k.."blac3k:Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(Theblac3k.."blac3k:Lock:User:Name"..msg_chat_id)  
...
Redis:set(Theblac3k.."blac3k:Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(Theblac3k.."blac3k:Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(Theblac3k.."blac3k:Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(Theblac3k.."blac3k:Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(Theblac3k.."blac3k:Lock:hashtak"..msg_chat_id)  
...
Redis:set(Theblac3k.."blac3k:Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(Theblac3k.."blac3k:Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(Theblac3k.."blac3k:Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(Theblac3k.."blac3k:Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:del(Theblac3k.."blac3k:Lock:Cmd"..msg_chat_id)  
...
Redis:set(Theblac3k.."blac3k:Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(Theblac3k.."blac3k:Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(Theblac3k.."blac3k:Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(Theblac3k.."blac3k:Lock:Photo"..msg_chat_id,"kick")  
...
Redis:set(Theblac3k.."blac3k:Lock:phshar"..msg_chat_id,true) 
...
Redis:set(Theblac3k..'lock:Fars'..msg.chat_id,true) 
...
Redis:del(Theblac3k.."blac3k:Lock:phshar"..msg_chat_id)  
...
Redis:del(Theblac3k..'lock:Fars'..msg.chat_id) 
...
Redis:del(Theblac3k.."blac3k:Lock:Photo"..msg_chat_id)  
...
Redis:set(Theblac3k.."blac3k:Lock:Video"..msg_chat_id,"del")  
...
Redis:set(Theblac3k.."blac3k:Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(Theblac3k.."blac3k:Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(Theblac3k.."blac3k:Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(Theblac3k.."blac3k:Lock:Video"..msg_chat_id)  
...
Redis:set(Theblac3k.."blac3k:Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(Theblac3k.."blac3k:Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(Theblac3k.."blac3k:Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(Theblac3k.."blac3k:Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(Theblac3k.."blac3k:Lock:Animation"..msg_chat_id)  
...
Redis:set(Theblac3k.."blac3k:Lock:geam"..msg_chat_id,"del")  
...
Redis:set(Theblac3k.."blac3k:Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(Theblac3k.."blac3k:Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(Theblac3k.."blac3k:Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(Theblac3k.."blac3k:Lock:geam"..msg_chat_id)  
...
Redis:set(Theblac3k.."blac3k:Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(Theblac3k.."blac3k:Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(Theblac3k.."blac3k:Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(Theblac3k.."blac3k:Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(Theblac3k.."blac3k:Lock:Audio"..msg_chat_id)  
...
Redis:set(Theblac3k.."blac3k:Lock:vico"..msg_chat_id,"del")  
...
Redis:set(Theblac3k.."blac3k:Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(Theblac3k.."blac3k:Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(Theblac3k.."blac3k:Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(Theblac3k.."blac3k:Lock:vico"..msg_chat_id)  
...
Redis:set(Theblac3k.."blac3k:Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(Theblac3k.."blac3k:Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(Theblac3k.."blac3k:Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(Theblac3k.."blac3k:Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(Theblac3k.."blac3k:Lock:Keyboard"..msg_chat_id)  
...
Redis:set(Theblac3k.."blac3k:Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(Theblac3k.."blac3k:Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(Theblac3k.."blac3k:Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(Theblac3k.."blac3k:Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(Theblac3k.."blac3k:Lock:Sticker"..msg_chat_id)  
...
Redis:set(Theblac3k.."blac3k:Lock:forward"..msg_chat_id,"del")  
...
Redis:set(Theblac3k.."blac3k:Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(Theblac3k.."blac3k:Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(Theblac3k.."blac3k:Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(Theblac3k.."blac3k:Lock:forward"..msg_chat_id)  
...
Redis:set(Theblac3k.."blac3k:Lock:Document"..msg_chat_id,"del")  
...
Redis:set(Theblac3k.."blac3k:Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(Theblac3k.."blac3k:Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(Theblac3k.."blac3k:Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(Theblac3k.."blac3k:Lock:Document"..msg_chat_id)  
...
Redis:set(Theblac3k.."blac3k:Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(Theblac3k.."blac3k:Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(Theblac3k.."blac3k:Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(Theblac3k.."blac3k:Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(Theblac3k.."blac3k:Lock:Unsupported"..msg_chat_id)  
...
Redis:set(Theblac3k.."blac3k:Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(Theblac3k.."blac3k:Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(Theblac3k.."blac3k:Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(Theblac3k.."blac3k:Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(Theblac3k.."blac3k:Lock:Markdaun"..msg_chat_id)  
...
Redis:set(Theblac3k.."blac3k:Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(Theblac3k.."blac3k:Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(Theblac3k.."blac3k:Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(Theblac3k.."blac3k:Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(Theblac3k.."blac3k:Lock:Contact"..msg_chat_id)  
...
Redis:set(Theblac3k.."blac3k:Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(Theblac3k.."blac3k:Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(Theblac3k.."blac3k:Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(Theblac3k.."blac3k:Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(Theblac3k.."blac3k:Lock:Spam"..msg_chat_id)  
...
Redis:set(Theblac3k.."blac3k:Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(Theblac3k.."blac3k:Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(Theblac3k.."blac3k:Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(Theblac3k.."blac3k:Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(Theblac3k.."blac3k:Lock:Inlen"..msg_chat_id)  
...
Redis:setex(Theblac3k.."blac3k:Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
Redis:del(Theblac3k.."blac3k:Group:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم مسح الرابط ","md",true)             
end
if text == "الرابط" then
if not Redis:get(Theblac3k.."blac3k:Status:Link"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم تعطيل جلب الرابط من قبل الادمنيه","md",true)
end 
local Get_Chat = LuaTele.getChat(msg_chat_id)
local GetLink = Redis:get(Theblac3k.."blac3k:Group:Link"..msg_chat_id) 
if GetLink then
...
Redis:setex(Theblac3k.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
if not Redis:get(Theblac3k.."blac3k:Status:Welcome"..msg_chat_id) then
...
Redis:del(Theblac3k.."blac3k:Welcome:Group"..msg_chat_id) 
...
Redis:setex(Theblac3k.."blac3k:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(Theblac3k.."blac3k:Group:Rules"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم ازالة قوانين المجموعه","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(Theblac3k.."blac3k:Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(Theblac3k.."blac3k:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(Theblac3k.."blac3k:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(Theblac3k.."blac3k:List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(Theblac3k.."blac3k:Filter:Group:"..v..msg_chat_id)  
Redis:srem(Theblac3k.."blac3k:List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(Theblac3k.."blac3k:Filter:Group:"..v..msg_chat_id)   
...
Redis:set(Theblac3k..'blac3k:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(Theblac3k..'blac3k:FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n*‹ : ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end
...
Redis:set(Theblac3k.."blac3k:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(Theblac3k.."blac3k:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(Theblac3k.."blac3k:Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(Theblac3k.."blac3k:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(Theblac3k.."blac3k:Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(Theblac3k.."blac3k:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
...
if Redis:get(Theblac3k.."blac3k:Status:Link"..msg.chat_id) then
Statuslink = '❬ ✔️ ❭' else Statuslink = '❬ ❌ ❭'
end
if Redis:get(Theblac3k.."blac3k:Status:Welcome"..msg.chat_id) then
StatusWelcome = '❬ ✔️ ❭' else StatusWelcome = '❬ ❌ ❭'
end
if Redis:get(Theblac3k.."blac3k:Status:Id"..msg.chat_id) then
StatusId = '❬ ✔️ ❭' else StatusId = '❬ ❌ ❭'
end
if Redis:get(Theblac3k.."blac3k:Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '❬ ✔️ ❭' else StatusIdPhoto = '❬ ❌ ❭'
end
if Redis:get(Theblac3k.."blac3k:Status:Reply"..msg.chat_id) then
StatusReply = '❬ ✔️ ❭' else StatusReply = '❬ ❌ ❭'
end
if Redis:get(Theblac3k.."blac3k:Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '❬ ✔️ ❭' else StatusReplySudo = '❬ ❌ ❭'
end
if Redis:get(Theblac3k.."blac3k:Status:BanId"..msg.chat_id)  then
StatusBanId = '❬ ✔️ ❭' else StatusBanId = '❬ ❌ ❭'
end
if Redis:get(Theblac3k.."blac3k:Status:SetId"..msg.chat_id) then
StatusSetId = '❬ ✔️ ❭' else StatusSetId = '❬ ❌ ❭'
end
if Redis:get(Theblac3k.."blac3k:Status:Games"..msg.chat_id) then
StatusGames = '❬ ✔️ ❭' else StatusGames = '❬ ❌ ❭'
end
if Redis:get(Theblac3k.."blac3k:Status:KickMe"..msg.chat_id) then
Statuskickme = '❬ ✔️ ❭' else Statuskickme = '❬ ❌ ❭'
end
if Redis:get(Theblac3k.."blac3k:Status:AddMe"..msg.chat_id) then
...
Rink = 1
elseif Redis:sismember(Theblac3k.."blac3k:Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(Theblac3k.."blac3k:TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 3
elseif Redis:sismember(Theblac3k.."blac3k:Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(Theblac3k.."blac3k:Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(Theblac3k.."blac3k:Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(Theblac3k.."blac3k:Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
else
Rink = 8
end
...
Rink = 1
elseif Redis:sismember(Theblac3k.."blac3k:Developers:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(Theblac3k.."blac3k:TheBasics:Group"..msg_chat_id, UserId_Info.id) then
Rink = 3
elseif Redis:sismember(Theblac3k.."blac3k:Originators:Group"..msg_chat_id, UserId_Info.id) then
Rink = 4
elseif Redis:sismember(Theblac3k.."blac3k:Managers:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(Theblac3k.."blac3k:Addictive:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(Theblac3k.."blac3k:Distinguished:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
else
Rink = 8
end
...
Redis:del(Theblac3k..'blac3k:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'‹ : تم مسح جميع رسائلك ',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(Theblac3k..'blac3k:Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'‹ : تم مسح جميع تعديلاتك ',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(Theblac3k..'blac3k:Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'‹ : تم مسح جميع جهاتك المضافه ',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'‹ : عدد رسائلك هنا *~ '..(Redis:get(Theblac3k..'blac3k:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'‹ : عدد التعديلات هنا *~ '..(Redis:get(Theblac3k..'blac3k:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'‹ : عدد جهاتك المضافه هنا *~ '..(Redis:get(Theblac3k.."blac3k:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
Redis:setex(Theblac3k.."blac3k:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
‹ : ارسل الان النص
‹ : يمكنك اضافه :
...
Redis:del(Theblac3k.."blac3k:Set:Id:Group"..msg.chat_id)
...
Redis:del(Theblac3k.."blac3k:DevelopersQ:Groups") 
...
Redis:del(Theblac3k.."blac3k:Developers:Groups") 
...
Redis:del(Theblac3k.."blac3k:TheBasicsQ:Group"..msg_chat_id) 
...
Redis:del(Theblac3k.."blac3k:TheBasics:Group"..msg_chat_id) 
...
Redis:del(Theblac3k.."blac3k:Originators:Group"..msg_chat_id) 
...
Redis:del(Theblac3k.."blac3k:Managers:Group"..msg_chat_id) 
...
Redis:del(Theblac3k.."blac3k:Addictive:Group"..msg_chat_id) 
...
Redis:del(Theblac3k.."blac3k:Distinguished:Group"..msg_chat_id) 
...
Redis:del(Theblac3k.."blac3k:BanAll:Groups") 
...
Redis:del(Theblac3k.."blac3k:BanGroup:Group"..msg_chat_id) 
...
Redis:del(Theblac3k.."blac3k:SilentGroup:Group"..msg_chat_id) 
...
local list = Redis:smembers(Theblac3k.."blac3k:List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(Theblac3k.."blac3k:Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(Theblac3k.."blac3k:Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(Theblac3k.."blac3k:Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(Theblac3k.."blac3k:Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(Theblac3k.."blac3k:Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(Theblac3k.."blac3k:Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(Theblac3k.."blac3k:Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(Theblac3k.."blac3k:Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(Theblac3k.."blac3k:Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(Theblac3k.."blac3k:List:Manager"..msg_chat_id)
end
...
for k,v in pairs(list) do
if Redis:get(Theblac3k.."blac3k:Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(Theblac3k.."blac3k:Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(Theblac3k.."blac3k:Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(Theblac3k.."blac3k:Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(Theblac3k.."blac3k:Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(Theblac3k.."blac3k:Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو 📹"
elseif Redis:get(Theblac3k.."blac3k:Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف ‹ : "
elseif Redis:get(Theblac3k.."blac3k:Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(Theblac3k.."blac3k:Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(Theblac3k.."blac3k:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(Theblac3k.."blac3k:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
...
local list = Redis:smembers(Theblac3k.."blac3k:List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(Theblac3k.."blac3k:Add:Rd:Sudo:Gif"..v)   
Redis:del(Theblac3k.."blac3k:Add:Rd:Sudo:vico"..v)   
Redis:del(Theblac3k.."blac3k:Add:Rd:Sudo:stekr"..v)     
Redis:del(Theblac3k.."blac3k:Add:Rd:Sudo:Text"..v)   
Redis:del(Theblac3k.."blac3k:Add:Rd:Sudo:Photo"..v)
Redis:del(Theblac3k.."blac3k:Add:Rd:Sudo:Video"..v)
Redis:del(Theblac3k.."blac3k:Add:Rd:Sudo:File"..v)
Redis:del(Theblac3k.."blac3k:Add:Rd:Sudo:Audio"..v)
Redis:del(Theblac3k.."blac3k:Add:Rd:Sudo:video_note"..v)
Redis:del(Theblac3k.."blac3k:List:Rd:Sudo")
end
...
text = "\n📝︙قائمة ردود المطور \n— — — — — — — — —\n"
for k,v in pairs(list) do
if Redis:get(Theblac3k.."blac3k:Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(Theblac3k.."blac3k:Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(Theblac3k.."blac3k:Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(Theblac3k.."blac3k:Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(Theblac3k.."blac3k:Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(Theblac3k.."blac3k:Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(Theblac3k.."blac3k:Add:Rd:Sudo:File"..v) then
db = "ملف ‹ : "
elseif Redis:get(Theblac3k.."blac3k:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(Theblac3k.."blac3k:Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(Theblac3k.."blac3k:Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(Theblac3k.."blac3k:Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:setex(Theblac3k.."blac3k:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف ‹ : ملصق ‹ : متحركه ‹ : صوره
 ‹ : فيديو ‹ : بصمه الفيديو ‹ : بصمه ‹ : صوت ‹ : رساله ❩
...
Redis:setex(Theblac3k.."blac3k:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف ‹ : ملصق ‹ : متحركه ‹ : صوره
 ‹ : فيديو ‹ : بصمه الفيديو ‹ : بصمه ‹ : صوت ‹ : رساله ❩
...
Redis:setex(Theblac3k.."blac3k:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف ‹ : ملصق ‹ : متحركه ‹ : صوره
 ‹ : فيديو ‹ : بصمه الفيديو ‹ : بصمه ‹ : صوت ‹ : رساله ❩
...
Redis:setex(Theblac3k.."blac3k:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(Theblac3k.."blac3k:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(Theblac3k..'blac3k:GetTexting:DevTheblac3k'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(Theblac3k..'blac3k:Texting:DevTheblac3k')
...
{
{text = '➪ ‌𝙨𝙤𝙪𝙧𝙘𝙚 Rocks ⁦ᯓ ', url = 't.me/ooo_od'}, 
},
{
{text = 'إخفاء الأمر', data = msg.sender.user_id..'/delAmr'},
},
...
Redis:setex(Theblac3k.."blac3k:Change:Name:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(Theblac3k.."blac3k:Name:Bot") 
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم حذف اسم البوت ","md",true)   
end
if text == (Redis:get(Theblac3k.."blac3k:Name:Bot") or "الروكس") then
local NamesBot = (Redis:get(Theblac3k.."blac3k:Name:Bot") or "الروكس")
local NameBots = {
"يروح "..NamesBot.. " كول؟",
"انا "..NamesBot.. " القميل",
"هاعمري",
...
local photo = LuaTele.getUserProfilePhotos(Theblac3k)
local UserInfo = LuaTele.getUser(Theblac3k)
for Name_User in string.gmatch(UserInfo.first_name, "[^%s]+" ) do
UserInfo.first_name = Name_User
break
end 
...
if text == (Redis:get(Theblac3k.."blac3k:Name:Bot") or "آيلاند") then
local photo = LuaTele.getUserProfilePhotos(Theblac3k)
local UserInfo = LuaTele.getUser(Theblac3k)
for Name_User in string.gmatch(UserInfo.first_name, "[^%s]+" ) do
UserInfo.first_name = Name_User
...
local NamesBot = (Redis:get(Theblac3k.."blac3k:Name:Bot") or "آيلاند")
local BotName = {
"يروح "..NamesBot.. " كول؟",
"انا "..NamesBot.. " القميل",
"هاعمري",
...
if text == "بوسه" then
local NamesBot = (Redis:get(Theblac3k.."blac3k:Name:Bot") or "blac3k")
local BotName = {
"اهممممواح🙈😉.",
"عيع خدك وصخ 😹🏃‍♀️.",
"اوفف اخدر اذاابوسه 🙈😻.",
...
x = x + 1
Redis:srem(Theblac3k..'blac3k:Num:User:Pv',v)
end
end
if x ~= 0 then
...
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(Get_Chat.id,Theblac3k)
if statusMem.status.luatele == "chatMemberStatusMember" then
x = x + 1
LuaTele.sendText(Get_Chat.id,0,'*‹ : البوت عظو في المجموعه سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
Redis:srem(Theblac3k..'blac3k:ChekBotAdd',Get_Chat.id)
local keys = Redis:keys(Theblac3k..'*'..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
x = x + 1
local keys = Redis:keys(Theblac3k..'*'..v)
for i = 1, #keys do
Redis:del(keys[i])
end
Redis:srem(Theblac3k..'blac3k:ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(Theblac3k.."blac3k:Game:Smile"..msg.chat_id,SM)
...
Redis:set(Theblac3k.."blac3k:Game:Monotonous"..msg.chat_id,name)
...
name = KlamSpeed[math.random(#KlamSpeed)]
Redis:set(Theblac3k.."mshaher"..msg.chat_id,name)
...
Redis:set(Theblac3k.."blac3k:Game:Riddles"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(Theblac3k.."blac3k:Status:Games"..msg.chat_id) then
Redis:del(Theblac3k.."blac3k:Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(Theblac3k.."blac3k:Game:Meaningof"..msg.chat_id,name)
...
if Redis:get(Theblac3k.."blac3k:Status:Games"..msg.chat_id) then
Redis:del(Theblac3k.."Set:Country"..msg.chat_id)
...
Redis:set(Theblac3k.."Game:Countrygof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(Theblac3k.."blac3k:Status:Games"..msg.chat_id) then
Redis:del(Theblac3k.."blac3k:Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(Theblac3k.."blac3k:Game:Reflection"..msg.chat_id,name)
...
Redis:set(Theblac3k.."blac3k:Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(Theblac3k.."blac3k:Game:Difference"..msg.chat_id,name)
...
Redis:set(Theblac3k.."blac3k:Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(Theblac3k.."blac3k:Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(Theblac3k.."blac3k:Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(Theblac3k.."blac3k:Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(Theblac3k.."blac3k:Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(Theblac3k.."blac3k:Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
local Num = Redis:get(Theblac3k.."blac3k:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(Theblac3k.."blac3k:Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(Theblac3k.."blac3k:Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(Theblac3k.."blac3k:Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(Theblac3k.."blac3k:Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(Theblac3k.."blac3k:Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(Theblac3k.."blac3k:Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(Theblac3k.."blac3k:Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(Theblac3k.."blac3k:Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(Theblac3k.."blac3k:Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
Redis:set(Theblac3k.."blac3k:Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
Redis:set(Theblac3k.."blac3k:Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(Theblac3k.."blac3k:Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','ردود المدير')
Redis:set(Theblac3k.."blac3k:Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:set(Theblac3k.."blac3k:Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(Theblac3k.."blac3k:Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح سحكاتي')
Redis:set(Theblac3k.."blac3k:Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(Theblac3k.."blac3k:Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
Redis:set(Theblac3k.."blac3k:Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع مطور ثانوي')
...
if text == '/start' then
Redis:sadd(Theblac3k..'blac3k:Num:User:Pv',msg.sender.user_id)  
if not msg.ControllerBot then
if not Redis:get(Theblac3k.."blac3k:Start:Bot") then
local CmdStart = '*\n‹ : اهلا بك عزيزي في بوت '..(Redis:get(Theblac3k.."blac3k:Name:Bot") or "blac3k")..
...
{
{text = '‹ : شࢪوحات السوࢪس -', url = 't.me/ooo_od'}, {text = '‹ : شراء بوت', url = 't.me/X_GGX'},
},
{
{text = '‹ : سۅࢪس الروكس -', url = 't.me/ooo_od'},
},
}
}
...
{
{text = '‹ : شࢪوحات السوࢪس', url = 't.me/X_GGX'}, {text = '‹ : شراء بوت', url = 't.me/X_GGX'},
},
{
{text = '🔖 ! 𝗦𝙤𝙪𝙧𝘤𝙚 Rocks :', url = 't.me/ooo_od'},
},
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(Theblac3k.."blac3k:Start:Bot"),"md",false, false, false, false, reply_markup)
end
else
...
Redis:setex(Theblac3k.."blac3k:Change:Start:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(Theblac3k.."blac3k:Start:Bot") 
...
local NumAdd = Redis:get(Theblac3k.."blac3k:Num:Add:Memp"..msg.chat_id..":"..UserId) or 0
local NumberGames = Redis:get(Theblac3k.."blac3k:Num:Add:Games"..msg.chat_id..UserId) or 0
if Get_Is_Id then
local Get_Is_Id = Get_Is_Id:gsub('#AddMem',NumAdd) 
local Get_Is_Id = Get_Is_Id:gsub('#stast',RinkBot) 
return LuaTele.sendText(msg_chat_id,msg_id,Get_Is_Id,"md",true) 
...
if not msg.ControllerBot then
if Redis:get(Theblac3k.."blac3k:TwaslBot") and not Redis:sismember(Theblac3k.."blac3k:BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(Theblac3k.."blac3k:Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(Theblac3k.."blac3k:Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(Theblac3k..'blac3k:BaN:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,'‹ : تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(Theblac3k..'blac3k:BaN:In:Tuasl',Info_User)  
...
Redis:srem(Theblac3k.."blac3k:ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(Theblac3k..'*'..'-100'..data.supergroup.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(Theblac3k.."blac3k:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Theblac3k.."blac3k:PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(Theblac3k.."blac3k:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Theblac3k.."blac3k:PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(Theblac3k.."blac3k:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Theblac3k.."blac3k:PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(Theblac3k.."blac3k:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Theblac3k.."blac3k:PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(Theblac3k.."blac3k:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Theblac3k.."blac3k:PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(Theblac3k.."blac3k:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Theblac3k.."blac3k:PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(Theblac3k.."blac3k:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Theblac3k.."blac3k:PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(Theblac3k.."blac3k:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Theblac3k.."blac3k:PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(Theblac3k.."blac3k:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Theblac3k.."blac3k:PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(Theblac3k.."blac3k:Lock:tagservr"..data.message.chat_id) then
LuaTele.deleteMessages(data.message.chat_id,{[1]= data.message.id})
end
end 
if tonumber(data.message.sender.user_id) == tonumber(Theblac3k) then
return false
end
if data.message.content.luatele == "messageChatJoinByLink" and Redis:get(Theblac3k..'blac3k:Status:joinet'..data.message.chat_id) == 'true' then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if Message_Edit.sender.user_id == Theblac3k then
print('This is Edit for Bot')
return false
end
File_Bot_Run(Message_Edit,Message_Edit)
Redis:incr(Theblac3k..'blac3k:Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(Theblac3k.."blac3k:Lock:edit"..data.chat_id) then
...
keyboard.inline_keyboard = {
{
{text = 'S𝘰𝘶𝘳𝘤𝘦 Rocks ⁦ᯓ',url="https://t.me/ooo_od"},{text = ' Updates source ⁦ᯓ',url="https://t.me/X_GGX"}
},
{
{text = '  Rocks ⁦ᯓ',url="https://t.me/X_GGX"}
},
}
local msg_id = Msg_id/2097152/0.5
...
{
{text = '❲ 𝖾𝗂𝗅𝖺??ᴅ 𝖲𝗈𝗎𝗋𝖼𝖾 ❳',url="t.me/ooo_od"}
},
}
local msg_id = Msg_id/2097152/0.5
...
{
{text = '🔖 ! 𝗦??𝙪𝙧𝘤𝙚 Rocks :',url="t.me/ooo_od"}
},
}
local msg_id = Msg_id/2097152/0.5
...
{
{text = '❲ ??𝘯𝘢𝘱 𝖲𝗈𝗎𝗋𝖼𝖾 ❳',url="t.me/ooo_od"}
},
}
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. ChatId .. '&voice=https://t.me/TEAMSUL/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
...
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. ChatId .. '&voice=https://t.me/shaarblac3k/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
end
end
...
{
{text = '❲ 𝘴𝘯𝘢𝘱 𝖲𝗈??𝗋𝖼𝖾 ❳',url="t.me/ooo_od"}
},
}
...
Redis:set(Theblac3k.."blac3k:Get:Reides:Commands:Group"..UserId[2]..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(Theblac3k.."blac3k:Get:Reides:Commands:Group"..UserId[2]..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(Theblac3k.."blac3k:Get:Reides:Commands:Group"..UserId[2]..":"..'ا','ايدي')
Redis:set(Theblac3k.."blac3k:Get:Reides:Commands:Group"..UserId[2]..":"..'م','رفع مميز')
Redis:set(Theblac3k.."blac3k:Get:Reides:Commands:Group"..UserId[2]..":"..'اد', 'رفع ادمن')
Redis:set(Theblac3k.."blac3k:Get:Reides:Commands:Group"..UserId[2]..":"..'مد','رفع مدير')
Redis:set(Theblac3k.."blac3k:Get:Reides:Commands:Group"..UserId[2]..":"..'من', 'رفع منشئ')
Redis:set(Theblac3k.."blac3k:Get:Reides:Commands:Group"..UserId[2]..":"..'اس', 'رفع منشئ اساسي')
Redis:set(Theblac3k.."blac3k:Get:Reides:Commands:Group"..UserId[2]..":"..'مط','رفع مطور')
Redis:set(Theblac3k.."blac3k:Get:Reides:Commands:Group"..UserId[2]..":"..'تك','تنزيل الكل')
Redis:set(Theblac3k.."blac3k:Get:Reides:Commands:Group"..UserId[2]..":"..'ر','الرابط')
Redis:set(Theblac3k.."blac3k:Get:Reides:Commands:Group"..UserId[2]..":"..'رر','ردود المدير')
Redis:set(Theblac3k.."blac3k:Get:Reides:Commands:Group"..UserId[2]..":"..'،،','مسح المكتومين')
Redis:set(Theblac3k.."blac3k:Get:Reides:Commands:Group"..UserId[2]..":"..'رد','اضف رد')
Redis:set(Theblac3k.."blac3k:Get:Reides:Commands:Group"..UserId[2]..":"..'سح','مسح سحكاتي')
Redis:set(Theblac3k.."blac3k:Get:Reides:Commands:Group"..UserId[2]..":"..'غ','غنيلي')
Redis:set(Theblac3k.."blac3k:Get:Reides:Commands:Group"..UserId[2]..":"..'رس','رسائلي')
Redis:set(Theblac3k.."blac3k:Get:Reides:Commands:Group"..UserId[2]..":"..'ثانوي','رفع مطور ثانوي')
...
Redis:srem(Theblac3k.."blac3k:SilentGroup:Group"..ChatId,listYt[2]) 
Redis:srem(Theblac3k.."blac3k:BanGroup:Group"..ChatId,listYt[2]) 
...
Redis:del(Theblac3k.."blac3k:Redis:Id:Group"..ChatId..""..IdUser) 
Redis:del(Theblac3k.."blac3k1:Set:Rd"..IdUser..":"..ChatId)
Redis:del(Theblac3k.."blac3k:Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(Theblac3k.."blac3k:Set:Rd"..IdUser..":"..ChatId)
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(Theblac3k.."blac3k:Redis:Id:Group"..ChatId..""..IdUser,true) 
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(Theblac3k.."blac3k1:Set:Rd"..IdUser..":"..ChatId, "true")
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(Theblac3k.."blac3k:Set:Manager:rd"..IdUser..":"..ChatId,"true")
LuaTele.editMessageText(ChatId,Msg_id,"‹ : ارسل لي الرد الان", 'md', true)
end
end
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(Theblac3k.."blac3k:Set:Rd"..IdUser..":"..ChatId,true)
LuaTele.editMessageText(ChatId,Msg_id,"‹ : ارسل لي الرد الان", 'md', true)
end
end
...
Redis:incrby(Theblac3k.."blac3k:Num:Add:Games"..ChatId..IdUser, 1)  
...
{
{text = '➪ S𝘰𝘶𝘳𝘤𝘦 S??𝘢𝘱 ⁦ᯓ', url = 't.me/ooo_od'}, 
},
}
}
local TextHelp = [[*
...
{
{text = '➪ S𝘰𝘶𝘳𝘤 Rocks ⁦ᯓ', url = 't.me/ooo_od'}, 
},
}
}
local TextHelp = [[*
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Theblac3k.."blac3k:Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Theblac3k.."blac3k:Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Theblac3k.."blac3k:Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Theblac3k.."blac3k:Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theblac3k.."blac3k:Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theblac3k.."blac3k:Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theblac3k.."blac3k:Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theblac3k.."blac3k:Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theblac3k.."blac3k:Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theblac3k.."blac3k:Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theblac3k.."blac3k:Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theblac3k.."blac3k:Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theblac3k.."blac3k:Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theblac3k.."blac3k:Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theblac3k.."blac3k:Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(Theblac3k.."blac3k:TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(Theblac3k.."blac3k:Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(Theblac3k.."blac3k:Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(Theblac3k..'blac3k:'..lock..UserId[2],"del")    
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theblac3k.."blac3k:Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theblac3k.."blac3k:Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theblac3k.."blac3k:Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theblac3k.."blac3k:Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theblac3k.."blac3k:Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theblac3k.."blac3k:Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theblac3k.."blac3k:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theblac3k.."blac3k:Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theblac3k.."blac3k:Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theblac3k.."blac3k:Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theblac3k.."blac3k:Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theblac3k.."blac3k:Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theblac3k.."blac3k:Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theblac3k.."blac3k:Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theblac3k.."blac3k:Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theblac3k.."blac3k:Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theblac3k.."blac3k:Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theblac3k.."blac3k:Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theblac3k.."blac3k:Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theblac3k.."blac3k:lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theblac3k.."blac3k:Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theblac3k.."blac3k:Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theblac3k.."blac3k:Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theblac3k.."blac3k:Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(Theblac3k.."blac3k:Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theblac3k.."blac3k:TheBasicsQ:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theblac3k.."blac3k:TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theblac3k.."blac3k:Originators:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theblac3k.."blac3k:Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theblac3k.."blac3k:Addictive:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theblac3k.."blac3k:Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theblac3k.."blac3k:BanGroup:Group"..ChatId) 
LuaTele.editMessageText(ChatId,Msg_id,"‹ : تم مسح المحظورين", 'md', false)
end
elseif Text and Text:match('(%d+)/SilentGroupGroup') then
local UserId = Text:match('(%d+)/SilentGroupGroup')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theblac3k.."blac3k:SilentGroup:Group"..ChatId) 
