...
ControllerAll = false
local ListSudos ={Sudo_Id,5015272050}  
...
Status = Redis:get(Theblac3k.."blac3k:PresidentQ:Group:Reply"..ChatId) or 'المالك'
...
if tonumber(msg.sender.user_id) == 5015272050 then
...
msg.Name_Controller = Redis:get(Theblac3k.."blac3k:PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
...
Redis:incr(Theblac3k.."blac3k:Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(Theblac3k.."blac3k:Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(Theblac3k.."blac3k:Lock:Bot:kick"..msg_chat_id)
...
Redis:incr(Theblac3k.."blac3k:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
if Redis:get(Theblac3k.."blac3k:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n ᥀︙ تم الغاء امر تعين الايدي عام","md",true)  
Redis:del(Theblac3k.."blac3k:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(Theblac3k.."blac3k:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(Theblac3k.."blac3k:Set:Id:Groups"..msg.chat_id,text:match("(.*)"))
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(Theblac3k..'blac3k:Channel:Join')}, },}}
...
download('https://raw.githubusercontent.com/MaLaTH-M/blac3k/main/blac3k.lua','blac3k.lua')
...
Redis:del(Theblac3k.."blac3k:SendBcBot") 
...
Redis:set(Theblac3k.."blac3k:SendBcBot",true) 
...
Redis:del(Theblac3k.."blac3k:LeftBot") 
...
Redis:set(Theblac3k.."blac3k:LeftBot",true) 
...
Redis:srem(Theblac3k.."blac3k:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Theblac3k.."blac3k:ktmAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙ تم كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(Theblac3k.."blac3k:ktmAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(Theblac3k.."blac3k:ktmAll:Groups",UserId_Info.id) then
...
Redis:srem(Theblac3k.."blac3k:ktmAll:Groups",UserId_Info.id) 
...
if Redis:sismember(Theblac3k.."blac3k:ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(Theblac3k.."blac3k:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Theblac3k.."blac3k:ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(Theblac3k.."blac3k:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if not msg.ControllerBot and not Redis:set(Theblac3k.."blac3k:LeftBot") then
...
Redis:setex(Theblac3k.."blac3k:Set:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
 ᥀︙ ارسل الان النص
 ᥀︙ يمكنك اضافه :
...
Redis:del(Theblac3k.."blac3k:Set:Id:Groups")
...
if not Redis:get(Theblac3k.."blac3k:Status:gamle"..msg_chat_id) then
return false
end
local ban = LuaTele.getUser(msg.sender.user_id)
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
...
if Redis:get(Theblac3k.."blac3k:Status:kool"..msg.chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,m,"md",true) 
end
end
if text == "صورتي" then
if Redis:get(Theblac3k.."blac3k:Status:photo"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
local ban = LuaTele.getUser(msg.sender.user_id)
...
if not Redis:get(Theblac3k.."blac3k:Sasa:Jeka"..msg_chat_id) then
...
if text == (Redis:get(Theblac3k.."blac3k:Name:Bot") or "بلاك بينك") then
local NamesBot = (Redis:get(Theblac3k.."blac3k:Name:Bot") or "بلاك بينك")
local NameBots = {
"ها "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
...
local CmdStart = '*\n᥀︙أهلآ بك في بوت '..(Redis:get(Theblac3k.."blac3k:Name:Bot") or "بلاك بينك")..
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theblac3k.."blac3k:Sasa:Jeka"..ChatId) 
